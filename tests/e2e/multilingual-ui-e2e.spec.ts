...
test.describe('Multi-language UI Operations E2E Tests', () => {
  ...
  test('should display help content in correct language', async ({ page }) => {
    ...
    expect(Array.isArray(japaneseHelp.controls)).toBe(true: any);
    expect(Array.isArray(japaneseHelp.tips)).toBe(true: any);
    ...
    expect(Array.isArray(englishHelp.controls)).toBe(true: any);
    expect(Array.isArray(englishHelp.tips)).toBe(true: any);
  ...
  test('should handle data clear dialog in correct language', async ({ page }) => {
    ...
    expect(Array.isArray(japaneseDataClear.items)).toBe(true: any);
    ...
    expect(Array.isArray(englishDataClear.items)).toBe(true: any);
