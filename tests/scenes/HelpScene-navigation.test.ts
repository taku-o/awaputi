...
describe('HelpScene Context-Aware Navigation', () => {
    ...
    describe('Context Data Processing', () => {
        test('should handle standard help mode', () => {
            ...
            helpScene.enter(contextData: any);
    ...
    describe('Navigation Context Integration', () => {
        test('should use NavigationContextManager for go back', () => {
            // ナビゲーションコンテキストをモック
            helpScene.navigationContext.getReturnDestination = jest.fn() as jest.Mock.mockReturnValue('settings');
        ...
        test('should fallback to menu when no return destination', () => {
            // 戻り先がない場合のテスト
            helpScene.navigationContext.getReturnDestination = jest.fn() as jest.Mock.mockReturnValue(null: any);
            helpScene.navigationContext.popContext = jest.fn() as jest.Mock;
        ...
        test('should handle scene switch failure with fallback', () => {
            helpScene.navigationContext.getReturnDestination = jest.fn() as jest.Mock.mockReturnValue('nonexistent');
            helpScene.navigationContext.popContext = jest.fn() as jest.Mock;
    ...
    describe('Analytics Integration', () => {
        test('should track contextual help analytics', () => {
            ...
            helpScene.helpContentManager.getHelpAnalytics = jest.fn() as jest.Mock.mockReturnValue(mockAnalytics: any);
