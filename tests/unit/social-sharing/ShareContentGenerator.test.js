...
describe('ShareContentGenerator', () => {
    ...
    describe('スコア共有メッセージ生成', () => {
        ...
        it('Twitter用スコアメッセージを生成する', () => {
            const result = generator.generateScoreMessage(scoreData, 'twitter', 'ja');
        ...
        it('Facebook用スコアメッセージを生成する', () => {
            const result = generator.generateScoreMessage(scoreData, 'facebook', 'ja');
        ...
        it('英語でメッセージを生成する', () => {
            ...
            const result = generator.generateScoreMessage(scoreData, 'twitter', 'en');
        ...
        it('カスタムURLを含める', () => {
            ...
            const result = generator.generateScoreMessage(scoreData, 'twitter', 'ja', { url });
            
            expect(result.url).toBe(url);
        });

        it('不正なプラットフォームでデフォルトを使用', () => {
            const result = generator.generateScoreMessage(scoreData, 'invalid', 'ja');
    ...
    describe('実績共有メッセージ生成', () => {
        ...
        it('Twitter用実績メッセージを生成する', () => {
            const result = generator.generateAchievementMessage(achievementData, 'twitter', 'ja');
        ...
        it('Facebook用実績メッセージを生成する', () => {
            const result = generator.generateAchievementMessage(achievementData, 'facebook', 'ja');
        ...
        it('レアリティ情報を含める', () => {
            ...
            const result = generator.generateAchievementMessage(rareAchievement, 'twitter', 'ja');
    ...
    describe('カスタムメッセージ生成', () => {
        ...
        it('カスタムメッセージを生成する', () => {
            const result = generator.generateCustomMessage(customData, 'twitter', 'ja');
        ...
        it('空のデータでもエラーにならない', () => {
            const result = generator.generateCustomMessage({}, 'twitter', 'ja');
            expect(result).toBeDefined();
    ...
    describe('Twitter最適化', () => {
        it('文字数制限を適用する', () => {
            ...
            const result = generator.optimizeForTwitter({
                text: longMessage,
                url: 'https://example.com'
            });
        ...
        it('ハッシュタグ制限を適用する', () => {
            ...
            const result = generator.optimizeForTwitter(data);
    ...
    describe('Facebook最適化', () => {
        it('長いメッセージを処理する', () => {
            ...
            const result = generator.optimizeForFacebook(data);
            expect(result).toBeDefined();
    ...
    describe('メッセージバリデーション', () => {
        ...
        it('プラットフォーム制限をチェックする', () => {
            ...
            const result = generator.validateMessage(tooLongMessage);
    ...
    describe('ハッシュタグ管理', () => {
        it('ハッシュタグを生成する', () => {
            ...
            const hashtags = generator.generateHashtags(data, 'twitter');
        ...
        it('プラットフォーム固有のハッシュタグを生成する', () => {
            ...
            const twitterTags = generator.generateHashtags(data, 'twitter');
            const facebookTags = generator.generateHashtags(data, 'facebook');
    ...
    describe('パラメータ置換', () => {
        it('基本パラメータを置換する', () => {
            ...
            const result = generator.replaceParameters(template, params);
    ...
    describe('多言語対応', () => {
        ...
        it('フォールバック言語を使用する', () => {
            const result = generator.generateScoreMessage(
                { score: 10000 },
                'twitter',
                'unsupported_lang'
            );
        ...
        it('RTL言語を検出する', () => {
            const isRTL = generator.isRTLLanguage('ar');
            expect(isRTL).toBe(true);
            
            const isNotRTL = generator.isRTLLanguage('ja');
    ...
    describe('エラーハンドリング', () => {
        it('無効なデータでエラーを処理する', () => {
            const result = generator.generateScoreMessage(null, 'twitter', 'ja');
        ...
        it('テンプレート不足でエラーを処理する', () => {
            ...
            const result = generator.generateScoreMessage({ score: 1000 }, 'twitter', 'ja');
    ...
    describe('統計', () => {
        it('生成統計を記録する', () => {
            ...
            generator.generateScoreMessage({ score: 1000 }, 'twitter', 'ja');
        ...
        it('統計レポートを取得する', () => {
            ...
            const report = generator.getStatsReport();
    ...
    describe('設定', () => {
        ...
        it('無効な設定を拒否する', () => {
            ...
            expect(() => {
                generator.updateConfig(invalidConfig);
            }).toThrow();
        });
    });
    ...
    describe('URL処理', () => {
        it('URLを短縮する', () => {
            ...
            const shortened = generator.shortenUrl(longUrl);
...
// テストユーティリティ関数
function createMockScoreData(overrides = {}) {
    return {
        score: 10000,
        stage: 'normal',
        combo: 3,
...
function createMockAchievementData(overrides = {}) {
    return {
        id: 'test_achievement',
        name: 'テスト実績',
