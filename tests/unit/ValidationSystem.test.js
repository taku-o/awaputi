...
describe('ValidationSystem', () => {
    ...
    describe('ルール設定', () => {
        ...
        test('複数のルールを一括設定できる', () => {
            validationSystem.setRules('audio', {
    ...
    describe('デフォルト値設定', () => {
        ...
        test('複数のデフォルト値を一括設定できる', () => {
            validationSystem.setDefaultValues('audio', {
                volume: 0.5,
                muted: false
            });
    ...
    describe('文字列チェック', () => {
        beforeEach(() => {
            validationSystem.setRule('game', 'name', { 
                type: 'string', 
                minLength: 3, 
                maxLength: 20,
                pattern: /^[A-Za-z0-9_]+$/
    ...
    describe('列挙値チェック', () => {
        beforeEach(() => {
            validationSystem.setRule('game', 'difficulty', { 
                type: 'string', 
    ...
    describe('カスタム検証', () => {
        beforeEach(() => {
            validationSystem.setRule('game', 'evenNumber', { 
                type: 'number',
                validator: (value) => value % 2 === 0 || '偶数である必要があります'
            });
        ...
        test('カスタム検証でエラーが発生した場合は検証に失敗する', () => {
            validationSystem.setRule('game', 'buggyValidator', { 
