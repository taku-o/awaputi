...
describe('SyncManager', () => {
    ...
    describe('競合解決', () => {
        test('タイムスタンプによる競合解決（ローカル勝利）', async () => {
            const localData = { data: 'local', _metadata: { timestamp: 2000 } };
            const cloudData = { data: 'cloud', _cloudMetadata: { uploadedAt: 1000 } };
        ...
        test('同一データの競合スキップ', async () => {
            ...
            const localData = { ...identicalData, _metadata: { timestamp: 1000 } };
            const cloudData = { ...identicalData, _cloudMetadata: { uploadedAt: 2000 } };
    ...
    describe('データ比較', () => {
        test('同一データが正しく検出される', () => {
            const data1 = { name: 'test', value: 123, _metadata: { timestamp: 1000 } };
            const data2 = { name: 'test', value: 123, _cloudMetadata: { uploadedAt: 2000 } };
    ...
    describe('設定管理', () => {
        test('設定が正しく更新される', () => {
            const newConfig = {
                ...
                conflictResolutionStrategy: 'cloud'
            };
