...
class MockResponsiveCanvasManager {
    ...
    describe('validateCoordinates', () => {
        ...
        test('should reject invalid coordinates', () => {
            ...
            expect(scaledCoordinateManager.validateCoordinates(null as any, 20)).toBe(false);
            expect(scaledCoordinateManager.validateCoordinates(10, undefined as any)).toBe(false);
        });
    });
    describe('onScaleChange', () => {
        ...
        test('should ignore non-function callbacks', () => {
            ...
            scaledCoordinateManager.onScaleChange(null as any);
            scaledCoordinateManager.onScaleChange(undefined as any);
            expect(scaledCoordinateManager.scaleChangeCallbacks).toEqual([]);
        });
    });
