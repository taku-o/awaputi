...
describe('AchievementEventIntegrator', () => {
    ...
    describe('BubbleManager統合', () => {
        ...
        test('popBubbleメソッドが正しく拡張される', () => {
            const bubble = { type: 'normal', x: 100, y: 100 };
        ...
        test('バブルタイプ別統計が更新される', () => {
            const normalBubble = { type: 'normal' };
            const stoneBubble = { type: 'stone' };
        ...
        test('特殊バブル効果が追跡される', () => {
            const rainbowBubble = { type: 'rainbow' };
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('special')
            )).toBe(true);
        });
        ...
        test('速度チャレンジが追跡される', () => {
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('rapid')
            )).toBe(true);
        });
    });
    ...
    describe('ScoreManager統合', () => {
        ...
        test('スコア実績が更新される', () => {
            ...
            const updateCalls = mockAchievementManager.updateProgressCalls;
            expect(updateCalls.some(call => 
                call.achievementId.includes('score')
            )).toBe(true);
        });
        ...
        test('コンボ追跡が動作する', () => {
            ...
            const updateCalls = mockAchievementManager.updateProgressCalls;
            expect(updateCalls.some(call => 
                call.achievementId.includes('combo')
            )).toBe(true);
        });
        ...
        test('高倍率スコア実績が追跡される', () => {
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('bonus')
            )).toBe(true);
        });
    });
    ...
    describe('GameScene統合', () => {
        ...
        test('ゲームクリア実績が更新される', () => {
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('complete')
            )).toBe(true);
        });
        ...
        test('プレイ時間実績が追跡される', () => {
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('playtime')
            )).toBe(true);
        });
        ...
        test('低HP生存実績が追跡される', () => {
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('hp')
            )).toBe(true);
        });
        ...
        test('パーフェクトゲーム実績が追跡される', () => {
            ...
            expect(updateCalls.some(call => 
                ...
                call.achievementId.includes('flawless')
            )).toBe(true);
        });
    });
