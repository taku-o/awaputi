...
describe('ConfirmationDialog', () => {
    ...
    describe('Initialization', () => {
        it('should initialize with correct default configuration', () => {
            const config = (confirmationDialog as any).getDialogConfig() as DialogConfig;
        ...
        it('should initialize with dialog hidden', () => {
            expect((confirmationDialog as any).isVisible()).toBe(false);
        });

        it('should initialize with correct layout dimensions', () => {
            const dialogLayout = (confirmationDialog as any).dialogLayout as DialogLayout;
    ...
    describe('Dialog Display', () => {
        it('should show dialog with correct type and callbacks', () => {
            (confirmationDialog as any).show('giveUp', mockOnConfirm, mockOnCancel);
            
            expect((confirmationDialog as any).isVisible()).toBe(true);
            
            const state = (confirmationDialog as any).getDialogState() as DialogState;
        ...
        it('should reject invalid dialog types', () => {
            ...
            (confirmationDialog as any).show('invalid', mockOnConfirm, mockOnCancel);
        ...
        it('should hide dialog and clear state', () => {
            (confirmationDialog as any).show('restart', mockOnConfirm, mockOnCancel);
    ...
    describe('Click Handling', () => {
        ...
        it('should detect clicks on confirm button correctly', () => {
            const isConfirmClicked = (confirmationDialog as any).isButtonClicked(300, 300, 'confirm');
            expect(isConfirmClicked).toBe(true);
        });

        it('should detect clicks on cancel button correctly', () => {
            const isCancelClicked = (confirmationDialog as any).isButtonClicked(420, 300, 'cancel');
            expect(isCancelClicked).toBe(true);
        });

        it('should reject clicks outside button bounds', () => {
            const isConfirmClicked = (confirmationDialog as any).isButtonClicked(200, 300, 'confirm');
            const isCancelClicked = (confirmationDialog as any).isButtonClicked(500, 300, 'cancel');
        ...
        it('should handle confirm button click and execute callback', () => {
            const handled = (confirmationDialog as any).handleClick(300, 300);
        ...
        it('should handle cancel button click and execute callback', () => {
            const handled = (confirmationDialog as any).handleClick(420, 300);
        ...
        it('should handle clicks inside dialog but outside buttons', () => {
            const handled = (confirmationDialog as any).handleClick(400, 200);
        ...
        it('should handle clicks outside dialog as cancel', () => {
            const handled = (confirmationDialog as any).handleClick(100, 100);
    ...
    describe('Hover State Management', () => {
        ...
        it('should update hover state for confirm button', () => {
            (confirmationDialog as any).updateMousePosition(300, 300);
        ...
        it('should update hover state for cancel button', () => {
            (confirmationDialog as any).updateMousePosition(420, 300);
        ...
        it('should clear hover state when mouse is outside buttons', () => {
            (confirmationDialog as any).updateMousePosition(400, 200);
    ...
    describe('Keyboard Navigation', () => {
        ...
        it('should handle Tab key to switch focus between buttons', () => {
            ...
            expect((confirmationDialog as any).dialogState.focusedButton).toBe('cancel');
            
            const handled = (confirmationDialog as any).handleKeyboard(event);
            
            expect(handled).toBe(true);
            expect(event.preventDefault).toHaveBeenCalled();
            expect((confirmationDialog as any).dialogState.focusedButton).toBe('confirm');
        });

        it('should handle Enter key to execute focused button', () => {
            (confirmationDialog as any).dialogState.focusedButton = 'confirm';
        ...
        it('should handle Space key to execute focused button', () => {
            (confirmationDialog as any).dialogState.focusedButton = 'cancel';
        ...
        it('should handle arrow keys to navigate between buttons', () => {
            ...
            (confirmationDialog as any).dialogState.focusedButton = 'cancel';
            const handled = (confirmationDialog as any).handleKeyboard(leftEvent);
    ...
    describe('Legacy Keyboard Handling', () => {
        ...
        it('should handle Enter key with legacy method', () => {
            const handled = (confirmationDialog as any).handleKeyboard('Enter');
        ...
        it('should handle Return key with legacy method', () => {
            const handled = (confirmationDialog as any).handleKeyboard('Return');
        ...
        it('should handle Escape key with legacy method', () => {
            const handled = (confirmationDialog as any).handleKeyboard('Escape');
    ...
    describe('Dialog Positioning', () => {
        it('should center dialog on canvas', () => {
            (confirmationDialog as any).updateDialogPosition();
    ...
    describe('Direct Action Methods', () => {
        ...
        it('should execute confirm action directly', () => {
            (confirmationDialog as any).executeConfirm();
        ...
        it('should execute cancel action directly', () => {
            (confirmationDialog as any).executeCancel();
        ...
        it('should handle missing callbacks gracefully', () => {
            (confirmationDialog as any).show('restart', null, null);
    ...
    describe('Rendering', () => {
        ...
        it('should render when dialog is visible', () => {
            ...
            (confirmationDialog as any).render(mockContext);
        ...
        it('should use different colors for different button states', () => {
            (confirmationDialog as any).show('giveUp', mockOnConfirm, mockOnCancel);
            (confirmationDialog as any).dialogState.hoveredButton = 'confirm';
        ...
        it('should update position before rendering', () => {
            ...
            const updateSpy = jest.spyOn(confirmationDialog as any, 'updateDialogPosition');
            (confirmationDialog as any).render(mockContext);
