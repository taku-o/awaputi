...
describe('EnhancedEffectManager', () => {
    ...
    describe('Integration Features', () => {
        test('should integrate with particle manager', () => {
            ...
            // Effects should be able to create particles
        ...
        test('should integrate with audio system', () => {
            ...
            // Some effects should trigger audio
    ...
    describe('Error Handling and Recovery', () => {
        test('should handle invalid effect parameters', () => {
            expect(() => {
                effectManager.addTransitionEffect(null as any, -100, { invalid: true });
            }).not.toThrow();
            
            expect(() => {
                effectManager.addLightSource('invalid' as any, 'invalid' as any, 'invalid' as any, null as any, -50);
            }).not.toThrow();
        });
