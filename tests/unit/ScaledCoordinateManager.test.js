...
describe('ScaledCoordinateManager', () => {
    ...
    describe('getScaleFactor', () => {
        ...
        test('should return 1.0 when both scale and scaleFactor are missing', () => {
            delete mockResponsiveCanvasManager.mockCanvasInfo.scale;
            delete mockResponsiveCanvasManager.mockCanvasInfo.scaleFactor;
    ...
    describe('validateCoordinates', () => {
        ...
        test('should reject invalid coordinates', () => {
            expect(scaledCoordinateManager.validateCoordinates('10', 20)).toBe(false);
            expect(scaledCoordinateManager.validateCoordinates(10, '20')).toBe(false);
    ...
    describe('onScaleChange', () => {
        ...
        test('should ignore non-function callbacks', () => {
            scaledCoordinateManager.onScaleChange('not a function');
