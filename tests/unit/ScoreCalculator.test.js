...
describe('ScoreCalculator', () => {
    ...
    describe('統計計算', () => {
        test('should calculate score statistics correctly', () => {
            ...
            const stats = calculator.calculateScoreStatistics(scoreHistory);
        ...
        test('should handle empty score history', () => {
            const stats = calculator.calculateScoreStatistics([]);
        ...
        test('should handle invalid input', () => {
            const stats = calculator.calculateScoreStatistics(null);
            expect(stats.total).toBe(0);
        });
    });
    ...
    describe('推奨戦略計算', () => {
        test('should recommend combo strategy for high combo', () => {
            ...
            const strategy = calculator.calculateRecommendedStrategy(gameState);
