...
describe('ComparisonEngine - Integration and System Tests', () => {
    ...
    describe('改善提案システム', () => {
        ...
        test('弱点エリアが正しく特定される', () => {
            ...
            suggestions.targetAreas.forEach((area: any) => {
        ...
        test('アクションプランが生成される', () => {
            ...
            if (suggestions.actionPlan.length > 0) {
                suggestions.actionPlan.forEach((action: any) => {
        ...
        test('期待される成果が計算される', () => {
            ...
            if (suggestions.expectedOutcomes.length > 0) {
                suggestions.expectedOutcomes.forEach((outcome: any) => {
        ...
        test('フォローアップアクションが生成される', () => {
            ...
            suggestions.followUpActions.forEach((action: any) => {
