...
describe('ComparisonEngine - Performance and Scalability Tests', () => {
    ...
    describe('ベンチマーク比較機能', () => {
        ...
        test('ベンチマーク比較が実行される', async () => {
            ...
            expect(result.comparison.available).toBe(true: any);
        ...
        test('プレイヤーIDが正しく匿名化される', () => {
            ...
            expect(anonymized1).toBe(anonymized2: any); // 同じIDは同じ匿名化結果
            expect(anonymized1).not.toBe(anonymized3: any); // 異なるIDは異なる匿名化結果
        ...
        test('ベンチマーク指標が正しく計算される', () => {
            ...
            const benchmark = comparisonEngine.calculateBenchmarkMetrics(playerMetrics: any);
        ...
        test('ベンチマーク詳細分析が生成される', () => {
            ...
            const analysis = comparisonEngine.generateBenchmarkAnalysis(comparison: any);
        ...
        test('標準偏差が正しく計算される', () => {
            ...
            const stdDev = comparisonEngine.calculateStandardDeviation(values: any);
        ...
        test('ベンチマークデータ品質評価', () => {
            ...
            const quality = comparisonEngine.assessBenchmarkDataQuality(playerMetrics: any);
            ...
            const highQuality = comparisonEngine.assessBenchmarkDataQuality(highQualityMetrics: any);
