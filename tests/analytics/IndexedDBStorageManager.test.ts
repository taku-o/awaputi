...
class MockIDBTransaction {
    ...
    constructor(stores: Map<string, MockIDBObjectStore>, storeNames: string | string[], mode: string) {
        this.stores = stores;
    ...
    objectStore(name: string): MockIDBObjectStore | undefined {
...
(global as any).IDBKeyRange = {
    only: jest.fn((value: any) => ({ type: 'only', value })),
    bound: jest.fn((lower: any, upper: any, lowerExclusive?: boolean, upperExclusive?: boolean) => ({
        type: 'bound',
        lower,
        upper,
        lowerExclusive,
    ...
    lowerBound: jest.fn((value: any, exclusive?: boolean) => ({
        type: 'lowerBound',
        lower: value,
        lowerExclusive: exclusive
    })),
    upperBound: jest.fn((value: any, exclusive?: boolean) => ({
        type: 'upperBound',
        upper: value,
