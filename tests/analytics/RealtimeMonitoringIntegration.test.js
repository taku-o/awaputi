import { RealtimeDashboard } from '../../src/analytics/RealtimeDashboard.js';
import { PerformanceWarningSystem } from '../../src/analytics/PerformanceWarningSystem.js';
import { DeveloperAlertSystem } from '../../src/analytics/DeveloperAlertSystem.js';
...
describe('リアルタイム監視システム統合テスト (Task 9.5)', () => {
    let container;
    let performanceDataCollector;
    let realtimeMonitor;
    let dashboard;
    let warningSystem;
    let errorSystem;
    let developerAlertSystem;
    let dataCollector;
    let trendAnalyzer;
