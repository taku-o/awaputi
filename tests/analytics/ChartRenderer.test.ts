...
describe('ChartRenderer', () => {
    ...
    beforeEach(() => {
        ...
        (global as any).Chart.mockImplementation(() => mockChart);
        (document.getElementById as jest.Mock).mockReturnValue(mockCanvas);
        ...
        chartRenderer.Chart = (global as any).Chart;
    ...
    describe('データ更新', () => {
        ...
        test('データポイント数が制限される', () => {
            ...
            limitedRenderer.Chart = (global as any).Chart;
    ...
    describe('キャンバス管理', () => {
        ...
        test('存在しないキャンバスを作成する', () => {
            ...
            (document.createElement as jest.Mock).mockReturnValue(mockCreatedCanvas);
