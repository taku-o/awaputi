...
export class EnvironmentManager {
    ...
    static cleanupTasks: Array<() => void> = [];
    ...
    static _fixJSDOMEnvironment() {
        ...
        if (typeof window !== 'undefined' && window.document) {
            ...
            if (!window.document.addEventListener || typeof window.document.addEventListener !== 'function') {
                window.document.addEventListener = jest.fn() as any;
                window.document.removeEventListener = jest.fn() as any;
    ...
    static _improveCanvasContext() {
        ...
        if (typeof HTMLCanvasElement !== 'undefined') {
            ...
            HTMLCanvasElement.prototype.getContext = jest.fn(function(this: HTMLCanvasElement, contextType: string, options?: any) {
                if (contextType === '2d') {
    ...
    static _improveESModulesCompatibility() {
        ...
        if (typeof global !== 'undefined') {
            ...
            if (!(global as any).__ES_MODULE__) {
     ...
     * テスト実行を適切な分離で実行
     */
    static isolateTestExecution(testFunction: (...args: any[]) => any) {
     ...
     * エラーレポート生成
     */
    static generateErrorReport(error: any, context: any = {}) {
        return {
            ...
            environment: {
                ...
                jestVersion: (jest as any).getVersion ? (jest as any).getVersion() : 'unknown',
