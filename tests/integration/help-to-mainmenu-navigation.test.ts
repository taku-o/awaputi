    ...
    describe('Error scenario testing', () => {
        ...
        test('should handle error conditions gracefully without crashing', () => {
            ...
            expect(() => {
                ...
                helpScene.simulateEscKey();
                // Restore for cleanup
                helpScene.gameEngine.sceneManager = originalSceneManager;
            }).not.toThrow();
            ...
            expect(() => {
                ...
                helpScene.simulateEscKey();
                // Restore for cleanup
                gameEngine.sceneManager.scenes = originalScenes;
            }).not.toThrow();
            ...
            expect(() => {
                ...
                helpScene.simulateEscKey();
                // Restore for cleanup
                gameEngine.sceneManager.switchScene = originalSwitchScene;
            }).not.toThrow();
        });
    });
