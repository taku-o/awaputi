...
import { HelpFeedbackSystem } from '../../../src/core/help/HelpFeedbackSystem.js';
import { KeyboardShortcutManager } from '../../../src/core/KeyboardShortcutManager.js';

describe('Help System Integration', () => {
    let helpScene;
    let helpAnalytics;
    let helpFeedbackSystem;
    let mockGameEngine;
    let mockCanvas;
    let mockContext;
