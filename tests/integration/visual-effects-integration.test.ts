...
describe('Visual Effects Integration Tests', () => {
    ...
    describe('Particle and Effect Manager Integration', () => {
        test('should coordinate particle creation with screen effects', async () => {
            ...
            const flashEffectId = effectManager.addTransitionEffect('flash', 500, {
                color: '#FFFFFF',
                intensity: 1.0
            });

            // Create particles that should be affected by the flash
            const particleEffectId = particleManager.createAdvancedBubbleEffect?.(400, 300, 'normal', 20, {
                particleCount: 15,
                color: '#FF0000'
            });
        ...
        test('should synchronize combo effects with particle bursts', async () => {
            ...
            const shakeEffectId = effectManager.addTransitionEffect('shake', 300, {
                intensity: 0.8,
                frequency: 10
            });
    ...
    describe('Animation Integration', () => {
        test('should coordinate UI animations with particle effects', async () => {
            ...
            // Animate UI element
            const animationId = animationManager.animateUIElement?.(uiElement, 'bounce', 800, {
                amplitude: 20,
                easing: 'easeOut'
            });

            // Create complementary particle effect
            const particleEffectId = particleManager.createAdvancedBubbleEffect?.(300, 200, 'normal', 12, {
                particleCount: 10,
