...
| **F11** | フルスクリーン切り替え | フルスクリーンモードと通常画面を切り替えます |

### 🆕 設定画面UIで利用可能な機能
以下の機能は設定画面のUIボタンから利用できます：
- **音声ミュート切り替え**: 設定画面の一般設定カテゴリ

### 🎮 ゲームコントロール機能
ギブアップとゲーム再開始機能は、画面右上のUIボタンから利用できます：
- **ギブアップボタン**: ゲーム中に表示。クリックで確認ダイアログが表示されます
- **ゲーム再開始ボタン**: ゲーム中・ゲームオーバー時に表示。クリックで確認ダイアログが表示されます
- **アクセシビリティ対応**: キーボードナビゲーション（Tab、Enter、Escape）とタッチ操作に対応
...
### 🆕 設定画面UIで利用可能
音量調整機能は設定画面のUIボタンから利用できます：
- **音量調整ボタン**: 設定画面の一般設定カテゴリで音量アップ/ダウンボタンを利用
...
### 🆕 設定画面UIで利用可能な機能
以下の機能は設定画面のアクセシビリティカテゴリから利用できます：

#### 個別アクセシビリティ設定
- **ハイコントラスト切り替え**: 高コントラストモードのオン/オフ
- **大きなテキスト切り替え**: テキストサイズの拡大/標準
- **モーション軽減切り替え**: アニメーション効果の軽減/標準

#### プロファイル管理
- **プロファイル切り替え**: デフォルト、高コントラスト、運動機能配慮の3つのプロファイル
- **設定エクスポート**: アクセシビリティ設定をJSON形式でエクスポート
- **設定インポート**: 以前エクスポートした設定をインポート
...
- **設定画面UI**: フルスクリーン、ミュート、音量調整、アクセシビリティ機能は設定画面のUIから利用できます
