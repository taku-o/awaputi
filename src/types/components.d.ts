...
import { Position, Size, Color, EventListener, UIComponent } from './global.js';
import { Scene, InputState } from './game.js';
...
// Manager interfaces
export interface Manager extends Component {
    initialized: boolean;
    reset(): void;
    pause(): void;
    resume(): void;
...
// UI Manager types
export interface UIManager extends Manager {
...
export interface Menu extends UIComponent {
    items: MenuItem[];
...
export interface MenuManager extends UIManager {
...
export interface Dialog extends UIComponent {
    title: string;
    message: string;
...
// Settings components
export interface SettingsPanel extends UIComponent {
...
export interface HelpSystem extends UIComponent {
    topics: HelpTopic[];
...
export interface InputField extends UIComponent {
    value: string;
    placeholder: string;
    maxLength: number;
    focused: boolean;
...
export interface Label extends UIComponent {
    text: string;
...
export interface Chart extends UIComponent {
    data: ChartData[];
    type: ChartType;
    colors: Color[];
...
export interface ScoreDisplay extends Label {
    score: number;
...
export interface TimerDisplay extends Label {
    time: number;
...
export interface HealthBar extends ProgressBar {
    maxHealth: number;
...
export interface NotificationManager extends Manager {
...
export interface Notification extends UIComponent {
    id: string;
    message: string;
...
export interface PerformanceMonitor extends Component {
    fps: number;
    frameTime: number;
    memoryUsage: number;
    renderTime: number;
...
export interface DebugConsole extends UIComponent {
