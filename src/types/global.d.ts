...
export interface DataManager<T = any> {
    data: T;
    load(): Promise<T>;
...
export interface AudioResource extends ResourceLoader {
    url: string;
...
export interface ImageResource extends ResourceLoader {
    url: string;
...
export interface Tween extends Animation {
    from: number;
    to: number;
    current: number;
