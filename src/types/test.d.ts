...
// モック関数の型
export interface MockedFunction<T extends (...args: any[]) => any> extends jest.MockedFunction<T> {
...
// 非同期テストユーティリティ
export interface AsyncTestUtils {
...
// イベントテストユーティリティ
export interface EventTestUtils {
    simulateClick(element: Element, options?: MouseEventInit): void;
