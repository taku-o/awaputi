...
export class EnhancedDebugInterface extends EffectDebugInterface {
    ...
    public getIntegrationTestResults(): any {
        const dataExporter = this.getComponent('dataExporter');
        return dataExporter?.getIntegrationTestResults ? dataExporter.getIntegrationTestResults() : null;
    }
    ...
    public getRequirementsValidationResults(): any {
        const dataExporter = this.getComponent('dataExporter');
        return dataExporter?.getRequirementsValidationResults ? dataExporter.getRequirementsValidationResults() : null;
    }
    ...
    public getFinalValidationResults(): any {
        const dataExporter = this.getComponent('dataExporter');
        return dataExporter?.getFinalValidationResults ? dataExporter.getFinalValidationResults() : null;
    }
