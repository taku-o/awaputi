...
export class ErrorSubmissionManager {
    ...
    public async submitError(error: any): Promise<SubmissionResult> {
        return this.submitErrors([error]);
    }

    public async submitErrors(errors: any[]): Promise<SubmissionResult> {
    ...
    public async submitBatch(): Promise<SubmissionResult[]> {
    ...
    private async processSubmission(submission: ErrorSubmission): Promise<SubmissionResult> {
        ...
        try {
            ...
            return this.handleSubmissionError(submission, error);
        }
    }

    private async sendToEndpoint(submission: ErrorSubmission): Promise<Response> {
        const payload = {
            submissionId: submission.id,
    ...
    private async handleSubmissionError(submission: ErrorSubmission, error: any): Promise<SubmissionResult> {
        console.warn(`[ErrorSubmissionManager] Submission failed:`, error);
    ...
    public clearFailedSubmissions(): number {
    ...
    public updateConfig(newConfig: Partial<SubmissionConfig>): void {
