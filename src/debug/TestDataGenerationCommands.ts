...
interface ComponentConstructor { 
    new (parent: TestDataGenerationCommands): Component;
}
...
export class TestDataGenerationCommands {
     ...
     * @returns コンポーネント
     */
    getComponent(name: string): Component | FallbackComponent | undefined { 
     ...
     * @param console - Developer Console インスタンス
     */
    registerUtilityCommands(console: DeveloperConsole): void { 
        // test.clear コマンド
     ...
     * @returns ハンドラー関数
     */
    getCommandHandler(command: string): Function | null { 
    ...
    getStatistics(): Statistics { 
        ...
        for (const [name, component] of this.components) {
            ...
            } else if (comp.getValidationStatistics) {
                stats.components[name] = comp.getValidationStatistics();
            } else {
