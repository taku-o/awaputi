...
interface FinalValidationResults {
    summary?: TestSummary;
    targets?: {
...
interface DebugInterface {
    runIntegrationTests?(): Promise<IntegrationTestResults>;
...
export class TestPanel {
     ...
     * モックバブルを生成
     */
    private generateMockBubbles(count: number): void {
        try {
     ...
     * ベンチマーク結果を追加
     */
    private addBenchmarkResult(message: string, type: 'info' | 'success' | 'warning' | 'error' = 'info'): void {
     ...
     * カテゴリ別統合テストを実行
     */
    private async runCategoryIntegrationTests(category: string): Promise<void> {
     ...
     * 統合テスト結果をエクスポート
     */
    private async exportIntegrationTestResults(): Promise<void> {
        try {
     ...
     * 要件検証テストを実行
     */
    private async runRequirementsValidation(): Promise<void> {
     ...
     * 要件検証結果をエクスポート
     */
    private async exportValidationResults(): Promise<void> {
        try {
     ...
     * 最終検証結果をエクスポート
     */
    private async exportFinalValidationResults(): Promise<void> {
        try {
