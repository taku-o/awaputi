...
export class ErrorScreenshotCapture {
    ...
    gameState: context.gameState  });
            if (screenshot) {
                ...
                return screenshot;} catch (captureError) { console.warn('Failed to capture error screenshot:', (captureError as Error).message }
        ...
        try { const canvas = this.gameEngine.canvas,
            ...
            if (needsResize) {
                ...
                return tempCanvas.toDataURL(;
                    ...
                    this.captureSettings.format }
                    this.captureSettings.quality); catch (error) { : undefined 
    ...
    private storeScreenshot(screenshot: Screenshot): void { try {
        ...
        } catch (error') { console.warn('Failed to store screenshot:', (error as Error).message }'
    }
