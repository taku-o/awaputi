...
export class DebugSuggestionEngine extends BaseComponent {
     ...
     * @param {Object} test - テスト情報
     * @returns {Array} コンテキスト特化提案
     */
    generateContextualSuggestions(pattern, test) {
        if (!test || !test.name) {
            return [];
        }
     ...
     * @param {Object} pattern - パターン情報
     * @param {Object} test - テスト情報
     * @returns {Array} ランク付けされた提案
     */
    rankSuggestions(suggestions, pattern, test) {
    ...
    /**
     * 提案のスコアを計算
     * @param {Object} suggestion - 提案
     * @param {Object} pattern - パターン情報
     * @param {Object} test - テスト情報
     * @returns {number} スコア
     */
    calculateSuggestionScore(suggestion, pattern, test) {
        let score = 0;
     ...
     * @returns {Array} 提案テンプレート
     */
    getSuggestionTemplates(patternId) {
