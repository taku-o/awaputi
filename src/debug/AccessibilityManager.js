...
export class AccessibilityManager {
    ...
    setupFocusManagement() {
        ...
        if (debugPanel) {
            ...
            debugPanel.addEventListener('focusout', (event) => {
                // フォーカスがパネル外に移動した場合
                if (!debugPanel.contains(event.relatedTarget)) {
    ...
    addAccessibilityStyles() {
        ...
        style.textContent = `
            ...
            /* フォーカス表示の強化 */
            .enhanced-debug-interface *:focus {
                outline: 2px solid #0066cc;
                outline-offset: 2px;
            }

            .enhanced-debug-interface.theme-high-contrast *:focus {
            ...
            .enhanced-debug-interface .debug-tab:focus {
                background-color: rgba(0, 102, 204, 0.3);
            }

            .enhanced-debug-interface.theme-high-contrast button:focus,
            .enhanced-debug-interface.theme-high-contrast .debug-tab:focus {
