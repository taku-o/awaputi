...
export class MockDataValidator {
    private bubbleRules: ValidationRule[] = [
    ...
    public validateBubbleData(bubble: any): ValidationResult {
        return this.validateData(bubble, this.bubbleRules);
    }

    public validateGameStateData(gameState: any): ValidationResult {
        return this.validateData(gameState, this.gameStateRules);
    }

    public validateUserData(user: any): ValidationResult {
        return this.validateData(user, this.userRules);
    }

    public validateBubbleArray(bubbles: any[]): ValidationResult {
        const results = bubbles.map(bubble => this.validateBubbleData(bubble));
        return this.combineResults(results);
    }

    public validateDataStructure(data: any, expectedStructure: any): ValidationResult {
        const errors: string[] = [];
