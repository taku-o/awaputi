...
'';
     ...
     * デバイスUser Agent取得'
     */''
    getDeviceUserAgent(device: string'): string { const userAgents: Record<string, string> = {''
     ...
     * デバイス画面サイズ取得'
     */''
    getDeviceScreen(device: string'): ScreenInfo { const screens: Record<string, ScreenInfo> = {' }'
