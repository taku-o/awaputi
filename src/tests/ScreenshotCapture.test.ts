...
describe('ScreenshotCapture', () => {  let screenshotCapture: ScreenshotCapture,
    ...
    beforeEach(async () => {
        ...
        revokeObjectURL: jest.fn()  } as any;
    ...
    describe('ゲームCanvasキャプチャ', () => {  beforeEach(() => {'
        ...
        test('JPEG形式でキャプチャできる', async () => { const result = await screenshotCapture.captureGameCanvas({ ')'
                format: 'jpeg',' }'
    ...
    describe('画像最適化', () => {  let mockImageData: ImageData,
        beforeEach(() => {'
            mockImageData = { }'
    ...
    describe('画像フォーマット変換', () => {  ''
        test('PNG画像が作成される', async () => {'
            ...
            expect(result).toHaveProperty('blob';
            expect(result).toHaveProperty('url';}');'
        test('JPEG画像が作成される', async () => {  mockCanvas.toBlob = jest.fn().mockImplementation((callback: (blob: Blob | null) => void, type?: string, quality?: number) => {''
    ...
    describe('ユーティリティ機能', () => {  ''
        ...
        test('ゲームCanvasが正しく取得される', () => {  const canvas = screenshotCapture.getGameCanvas() }
    ...
    describe('エラーハンドリング', () => {  ''
        ...
        test('重複キャプチャの防止', async () => {  screenshotCapture.capturing = true,
    ...
    describe('統計機能', () => {  ''
        ...
        test('エラー統計の記録', async () => {  screenshotCapture.gameEngine.canvas = null,
            
            try { }
                await screenshotCapture.captureGameCanvas(); }
            } catch (error) { // エラーは期待される }
