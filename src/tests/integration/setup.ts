...
declare global {
    ...
    var File: {
        new(bits: any[], name: string, options?: FilePropertyBag): File;
    };
    var FileReader: {
        new(): MockFileReader;
    };
    var Blob: {
        new(parts?: any[], options?: BlobPropertyBag): MockBlob;
    };
    var URL: MockURL;
    var ResizeObserver: {
    ...
    var IntersectionObserver: {
        new(callback: IntersectionObserverCallback): MockIntersectionObserver;
    };
...
// Image API モック
global.Image = class MockImageClass implements MockImage {
...
// ResizeObserver モック
global.ResizeObserver = class MockResizeObserverClass implements MockResizeObserver {
    callback: ResizeObserverCallback;
    ...
    observe(): void {
        ...
        setTimeout(() => {
            this.callback([{
                ...
                contentRect: { width: 800, height: 600, x: 0, y: 0, top: 0, right: 800, bottom: 600, left: 0 }
...
global.IntersectionObserver = class MockIntersectionObserverClass implements MockIntersectionObserver {
    callback: IntersectionObserverCallback;
...
const localStorageMock = (() => {
    ...
    return {
        getItem: jest.fn<string | null>((key: string) => store[key] || null),
        ...
        key: jest.fn<string | null>((index: number) => {
