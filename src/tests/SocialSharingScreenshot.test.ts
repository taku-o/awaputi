...
describe('SocialSharing Screenshot Integration', () => {  let socialSharingManager: SocialSharingManagerInstance,
    ...
    revokeObjectURL: jest.fn( };
        ...
        (global, as any).navigator = { share: jest.fn().mockResolvedValue(true),''
            ...
            language: 'ja-JP' ,} as MockNavigator;
    ...
    describe('領域指定スクリーンショット共有', () => {  ' }
        ...
        test('領域指定エラー時のフォールバック', async () => {  ' }
            ...
            await expect(socialSharingManager.shareRegionScreenshot();
                ...
                -10, -10, 0, 0, shareData)').rejects.toThrow('Region, capture failed';''
        }');
    ...
    describe('スクリーンショット機能の状態確認', () => {  ''
        ...
        test('WebPサポート確認', () => {  const capabilities = socialSharingManager.getScreenshotCapabilities();' }

            expect(capabilities.formats).toContain('webp';' }

        }');''
        test('Web Share Files サポート確認', () => {  const capabilities = socialSharingManager.getScreenshotCapabilities(); }

            expect(capabilities.webShareFiles).toBe(true);' }'

        }');''
        test('スクリーンショット統計の取得', () => { const stats = socialSharingManager.getScreenshotStats();
    ...
    optimized: false,);
        ...
        test('Twitter スクリーンショット共有統計', async () => { ' }
            ...
            await socialSharingManager.shareScreenshotViaTwitter({ ...shareData, }
        ...
        test('Facebook スクリーンショット共有統計', async () => { ' }
            ...
            await socialSharingManager.shareScreenshotViaFacebook({ ...shareData, }
        ...
        test('Web API スクリーンショット共有統計', async () => {  const shareData: ShareData = { ''
                type: 'challenge', ' }
