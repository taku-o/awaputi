...
'';
    private elementRequiresAccessibleName(element: Element, role: string | null'): boolean { const requiresNameRoles = [''
...
';
 ...
 : undefined'';
    private isGlobalAriaProperty(property: string'): boolean { const globalProps = [''
