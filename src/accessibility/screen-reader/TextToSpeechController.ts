...
interface EventHandlers {
    onStart: ((announcement: Announcement) => void) | null;
...
interface CurrentSpeechSettings extends SpeechSettings {
    voiceName: string;
}
...
export class TextToSpeechController {
     ...
     * Set speech voice
     */
    setSpeechVoice(voiceName: string): boolean {
     ...
     */
    getSpeechSettings(): CurrentSpeechSettings {
        return {
            ...this.speechSettings,
     ...
     */
    async testSpeech(text: string = 'Screen reader test announcement'): Promise<boolean> {
        try {
