...
interface StageManager {
    startStage(stageName: string): boolean;
}
...
export class GameStateManager {
    ...
    public endGame(): void {
        ...
        this.gameState.lastScore = this.gameEngine.playerData.currentScore;
     ...
     * 特殊効果をリセット
     */
    private resetSpecialEffects(): void {
     ...
     * @param points - 獲得ポイント
     */
    public onBubbleDestroyed(bubble: Bubble, points: number): void {
        // スコア更新
     ...
     * @param heal - 回復量
     */
    public onPlayerHealed(heal: number): number {
        const playerData = this.gameEngine.playerData;
     ...
     */
    public checkScoreChange(): boolean {
     ...
     * @returns 警告情報
     */
    public checkTimeWarning(): TimeWarnings {
