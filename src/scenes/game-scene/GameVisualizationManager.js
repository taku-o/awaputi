...
export class GameVisualizationManager {
     ...
     * @param {Object} current - 現在位置
     */
    renderDragTrajectory(context, start, current) {
     ...
     * @param {Object} current - 現在位置
     */
    renderForceIndicator(context, start, current) {
     ...
     * @param {Object} targetBubble - 対象の泡
     */
    renderTargetHighlight(context, targetBubble) {
