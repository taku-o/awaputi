...
export class AnalyticsChartRenderer {
    constructor(options = {}) {
        ...
        this.charts = new Map(); // アクティブなチャートインスタンス
        this.chartConfigs = new Map(); // チャート設定
        this.updateTimers = new Map(); // リアルタイム更新タイマー
        this.dataSourceCallbacks = new Map(); // データソースコールバック
     ...
     * リアルタイム更新の開始
     */
    startRealtimeUpdate(canvasId, dataSourceCallback, interval = null) {
     ...
     */
    drawSimpleLineChart(canvasId, data, config = {}) {
    ...
    getChartStatistics() {
        return {
            ...
            chartTypes: [...this.chartConfigs.values()].reduce((acc, config) => {
