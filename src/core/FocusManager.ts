...
export class FocusManager {
     ...
     * アクティベーションキー処理
     */
    handleActivationKey(event: any): void {
     ...
     */
    setFocus(element: any, options: any = {}): boolean {
     ...
     */
    announceElementFocus(element: any): void {
        try {
     ...
     * 要素の役割を取得
     */
    getElementRole(element: any): string {
        // aria-role
     ...
     * 要素の状態を取得
     */
    getElementState(element: any): string {
        const states = [];
     ...
     * フォーカストラップの作成
     */
    createFocusTrap(container: any, options: any = {}): any {
     ...
     * フォーカストラップの解放
     */
    releaseFocusTrap(trap: any): void { 
     ...
     */
    getFirstFocusableInContainer(container: any): any {
     ...
     * エラーハンドリング
     */
    handleError(error: any, errorCode: string, context: any = {}): void {
