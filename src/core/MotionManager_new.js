...
export class MotionManager {
    ...
    setMotionLevel(level) {
        return this.configManager.setMotionLevel(level);
    }
    ...
    getCategoryConfig(category) {
        return this.configManager.getCategoryConfig(category);
    }
    ...
    setCategoryConfig(category, config) {
        return this.configManager.setCategoryConfig(category, config);
    }
    
    /**
     * アニメーションの登録（アニメーション制御に委譲）
     */
    registerAnimation(element, category, options) {
        return this.animationController.registerAnimation(element, category, options);
    }
    ...
    unregisterAnimation(animationId) {
        return this.animationController.unregisterAnimation(animationId);
    }
     ...
     */
    pauseAllAnimations() {
        return this.animationController.pauseAllAnimations();
    }
     ...
     */
    resumeAllAnimations() {
        return this.animationController.resumeAllAnimations();
    }
    ...
    pauseAnimationsByCategory(category) {
        return this.animationController.pauseAnimationsByCategory(category);
    }
    ...
    resumeAnimationsByCategory(category) {
        return this.animationController.resumeAnimationsByCategory(category);
    }
    ...
    checkVestibularSafety() {
        return this.vestibularSafetyManager.checkVestibularSafety();
    }
     ...
     */
    emergencyStop() {
        return this.vestibularSafetyManager.emergencyStop();
    }
