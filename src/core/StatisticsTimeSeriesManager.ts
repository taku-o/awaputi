...
export class StatisticsTimeSeriesManager {
    ...
    getTimeSeriesData(options = {}) {
        try {
            ...
            // 集計処理
            if (aggregation !== 'none') {
                filteredData = this.aggregateData(filteredData, aggregation, metric);
            }
 ...
 */
export function getStatisticsTimeSeriesManager() {
...
export default StatisticsTimeSeriesManager;