...
';
    ...
    async generateCategoryFile(;
        ...
        translationObject._metadata.completionRate = processedData.totalKeys > 0 ?   : undefined;
    ...
    private flattenObject(obj: any, prefix: string = ''): { [key: string]: any } {'
        ...
        for (const [key, value] of Object.entries(obj)') {
            ...
            '';
            if(typeof value === 'object' && value !== null && !Array.isArray(value) { Object.assign(flattened, this.flattenObject(value, fullKey); }
