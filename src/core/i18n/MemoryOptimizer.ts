...
export class MemoryOptimizer {
    ...
    _checkMemoryPressure() {
        ...
        } else if (usageRatio >= this.warningThreshold && !this.isUnderMemoryPressure) { this._handleMemoryWarning(); }
        } else if (usageRatio < this.warningThreshold && this.isUnderMemoryPressure) { this._handleMemoryRecovery(); }
        }
    }
