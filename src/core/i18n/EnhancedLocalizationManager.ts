...
export interface PluralTranslationOptions extends TranslationOptions {
    pluralKey?: string;
    context?: string;
}

export interface ConditionalTranslationOptions extends TranslationOptions {
    condition?: any;
    inverse?: boolean;
}
...
export interface LanguageChangeListener {
    (newLanguage: string, oldLanguage: string): void;
}
...
export interface BulkTranslationOptions extends TranslationOptions {
    parallel?: boolean;
    batchSize?: number;
...
export class EnhancedLocalizationManager extends LocalizationManager {
     ...
     * 言語変更リスナーを削除
     */
    removeChangeListener(listener: LanguageChangeListener): boolean {
     ...
     * 言語変更をリスナーに通知
     */
    private notifyLanguageChange(newLanguage: string, oldLanguage: string): void {
