...
export class RTLLayoutManager {
    ...
    setLayoutDirection(direction: 'ltr' | 'rtl', language: string | null = null): boolean {
        try {
            ...
            getErrorHandler().handleError(error as Error, 'RTL_LAYOUT_ERROR', {
                direction: direction,
                language: language
            });
            return false;
    ...
    applyRTLLayout(element: HTMLElement, options: ApplyRTLOptions = {}): boolean {
        ...
        try {
            ...
            getErrorHandler().handleError(error as Error, 'RTL_ELEMENT_APPLICATION_ERROR', {
    ...
    removeRTLLayout(element: HTMLElement): boolean {
        ...
        try {
            ...
            getErrorHandler().handleError(error as Error, 'RTL_LAYOUT_REMOVAL_ERROR', {
                element: element.tagName
            });
            return false;
        }
