...
export class SocialI18nManager {
    constructor(localizationManager, options = {}) {
        ...
        // フォーマッター
        this.formatters = {
            number: this.createNumberFormatter.bind(this),
    ...
    interpolateMessage(template, params, language) {
        ...
        Object.keys(params).forEach(key => {
            ...
            if (typeof value === 'number') {
                ...
                formattedValue = this.formatDate(value, language);
            }
    ...
    createNumberFormatter(language) {
        try {
            ...
            return new Intl.NumberFormat(this.config.fallback.language);
        }
    }
    ...
    createDateFormatter(language) {
        try {
            ...
            return new Intl.DateTimeFormat(this.config.fallback.language);
        }
    }
