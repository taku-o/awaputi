...
export class TutorialOverlay extends BaseDialog {
     ...
     */
    async startTutorial(tutorial, options = {}) {
        try {
    ...
    async nextStep() {
        try {
            ...
            if (success) {
                this.progressTracker.recordStepComplete(this.stepManager.stepIndex - 1);
                this.displayCurrentStep();
            }
    ...
    createHighlightElement(targetElement, options = {}) {
        ...
        const padding = options.padding || this.layout.highlightPadding;
