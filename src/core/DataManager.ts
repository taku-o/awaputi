...
export class DataManager {
     ...
     */
    async save(dataType: string, data: any, options: SaveOptions = {}): Promise<any> {
     ...
     * PlayerDataの保存
     */
    async savePlayerData(data: any, options?: SaveOptions): Promise<any> {
        if (this.playerData) {
     ...
     * 設定データの保存
     */
    async saveSettings(data: any, options?: SaveOptions): Promise<any> {
        if (this.settingsManager) {
     ...
     * 設定データの読み込み
     */
    async loadSettings(options?: LoadOptions): Promise<any> {
        if (this.settingsManager) {
