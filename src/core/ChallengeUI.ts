...
export class ChallengeUI {
     ...
     */
    updateChallengeProgress(challengeId: string, newProgress: number): void {
    ...
    updateConfig(newConfig: Partial<ChallengeUIConfig>): void {
        ...
        if (newConfig.autoRefresh !== undefined) {
            this.config.autoRefresh = newConfig.autoRefresh;
        }
        // ... 他の設定項目も同様に処理
    ...
    get challengeSystemRef(): ChallengeSystem {
        return this.challengeSystem;
    }
    
    get configRef(): typeof this.config {
        return this.config;
    }
    
    get stateRef(): UIState {
        return this.state;
    }
    
    get statsRef(): UIStats {
        return this.stats;
    }
