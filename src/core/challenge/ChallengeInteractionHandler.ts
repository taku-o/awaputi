...
export class ChallengeInteractionHandler {
    ...
    activateCurrentItem(): void {
        ...
        if (focusedElement) {
            if (focusedElement.classList.contains('challenge-item')) {
                this.handleChallengeClick({ currentTarget: focusedElement } as MouseEvent);
            } else {
    ...
    setupTouchEvents(): void {
        ...
        this.elements.container.addEventListener('touchstart', (event: TouchEvent) => {
        ...
        this.elements.container.addEventListener('touchend', (event: TouchEvent) => {
