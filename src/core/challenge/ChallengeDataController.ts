...
export class ChallengeDataController {
     ...
     * デモチャレンジの生成
     */
    generateDemoChallenges(): Challenge[] {
     ...
     * チャレンジのフィルタリング
     */
    filterChallenges(challenges: Challenge[]): Challenge[] {
     ...
     * チャレンジのソート
     */
    sortChallenges(challenges: Challenge[]): Challenge[] {
     ...
     * 報酬のフォーマット
     */
    formatReward(reward: ChallengeReward): string {
        const parts: string[] = [];
