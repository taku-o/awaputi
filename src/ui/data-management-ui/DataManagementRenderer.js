...
export class UILayoutManager {
    ...
    calculateButtonPosition(buttonIndex, totalButtons, containerWidth) {
        ...
        return {
            x: startX + buttonIndex * (buttonWidth + padding),
            width: buttonWidth
        };
    }
}
...
export class UIRenderer {
    ...
    drawMenuHeader(bounds, title) {
        ...
        // Title
        this.drawText(title, bounds.x + padding, bounds.y + 30, {
            fontSize: 24,
            color: colors.text,
            align: 'left',
            baseline: 'middle',
...
export class ViewRenderer {
    ...
    renderBackupStatusCard(x, y, width, backupStatus, selected = false) {
        ...
        // Title
        this.uiRenderer.drawText('Backup Status', x + padding, y + padding, {
            fontSize: 18,
            bold: true
        });
        ...
        this.uiRenderer.drawText(`Last Backup: ${lastBackupText}`, x + padding, y + padding + 25, {
            fontSize: 14,
            color: colors.textSecondary
        });
        ...
        this.uiRenderer.drawText(`${backupStatus.backupCount} backups (${sizeText})`, x + padding, y + padding + 45, {
            fontSize: 14,
            color: colors.textSecondary
        });
    ...
    renderQuickActionsCard(x, y, width, selectedItem) {
        ...
        // Title
        this.uiRenderer.drawText('Quick Actions', x + padding, y + padding, {
            fontSize: 18,
            bold: true
        });
    ...
    renderExportOptionsCard(x, y, width, options, selectedItem) {
        ...
        // Title
        this.uiRenderer.drawText('Export Options', x + padding, y + padding, {
            fontSize: 18,
            bold: true
        });
