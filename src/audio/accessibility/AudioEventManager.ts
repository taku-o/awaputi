...
export class AudioEventManager {
     ...
     */
    public recordEvent(eventType: string, eventData: Record<string, any>): void {
        const event: AudioAccessibilityEvent = {
     ...
     * @returns イベント履歴
     */
    public getEventHistory(limit: number | null = null): AudioAccessibilityEvent[] {
     ...
     * @returns 指定タイプのイベント
     */
    public getEventsByType(eventType: string): AudioAccessibilityEvent[] {
     ...
     * @returns 指定期間のイベント
     */
    public getEventsByTimeRange(startTime: number, endTime: number = Date.now()): AudioAccessibilityEvent[] {
