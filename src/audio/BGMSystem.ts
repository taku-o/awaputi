...
export class BGMSystem {
     ...
     * @param curve - カーブタイプ
     */
    async fadeOut(duration: number, curve?: string): Promise<void> {
        try {
            if (!this.transitionManager) {
                throw new Error('TransitionManager is not initialized');
            }
     ...
     */
    async fadeIn(trackName: string, duration: number, curve?: string, targetVolume?: number): Promise<void> {
        try {
            if (!this.transitionManager) {
                throw new Error('TransitionManager is not initialized');
            }
     ...
     */
    updateTransitionSettings(settings: any): void {
        try {
            if (!this.transitionManager) {
                throw new Error('TransitionManager is not initialized');
            }
