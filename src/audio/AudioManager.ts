...
export class AudioManager {
     ...
     * @returns 品質設定オブジェクト
     */
    getQualitySettings(mode: string = this.qualityMode): QualitySettings {
 ...
 */
export function getAudioManager(configManager: ConfigManager, audioConfig: AudioConfig): AudioManager {
