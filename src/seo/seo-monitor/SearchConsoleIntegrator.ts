...
interface SearchConsoleAPIReadiness {
...
interface SearchConsoleIntegrationData {
    timestamp: number;
...
interface MonitoringData {
    searchConsoleMetrics: SearchConsoleIntegrationData[];
}
...
export class SearchConsoleIntegrator {
     ...
     */
    async prepareSearchConsoleIntegration(): Promise<SearchConsoleIntegrationData | null> {
        try {
     ...
     * サイトマップの検証
     */
    private async validateSitemap(): Promise<SitemapValidationResult> {
        try {
     ...
     * robots.txtの検証
     */
    private async validateRobotsTxt(): Promise<RobotsTxtValidationResult> {
        try {
     ...
     * インデックス可能ページの取得
     */
    private getIndexablePages(): IndexablePage[] {
     ...
     */
    private checkSearchConsoleAPIReadiness(): SearchConsoleAPIReadiness {
