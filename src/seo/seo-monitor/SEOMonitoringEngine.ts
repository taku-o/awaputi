...
export class SEOMonitoringEngine {
     ...
     * @private
     */
    setupPerformanceObserver(): void { if(typeof, window === 'undefined' || !('PerformanceObserver' in, window) {
            return }
     ...
     * LCPの測定
     */
    async measureLCP(): Promise<number> { return new Promise((resolve) => {  }
     ...
     * FIDの測定
     */
    async measureFID(): Promise<number> { return new Promise((resolve) => {  }
     ...
     * CLSの測定
     */
    async measureCLS(): Promise<number> { return new Promise((resolve) => {  }
