...
export class PerformanceValidator {
    ...
    async validatePerformanceOptimization(''';
            ...
            if (compressionTest.passed) { results.passed++; }
            ...
            if (resourceTest.passed) { results.passed++; }
            } else { results.warnings++; }
            }
    ...
    async validateAccessibilityCompliance(''';
            ...
            if (keyboardTest.passed) { results.passed++; }
            } else { results.warnings++; }
            }
            ...
            if (contrastTest.passed) { results.passed++; }
            } else { results.warnings++; }
            }
