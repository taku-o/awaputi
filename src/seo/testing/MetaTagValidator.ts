...
export class MetaTagValidator {
    ...
    async validateMetaTags(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'validateMetaTags');
        }
    }
    ...
    async validateOpenGraphTags(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'validateOpenGraphTags');
        }
    }
    ...
    async validateTwitterCardTags(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'validateTwitterCardTags');
        }
    }
    ...
    async validateSocialMediaOptimization(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'validateSocialMediaOptimization');
        }
    }
