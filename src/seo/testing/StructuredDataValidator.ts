...
export class StructuredDataValidator {
    ...
    async validateStructuredData(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'validateStructuredData');
        }
    }
    ...
    async validateJsonLdCompliance(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'validateJsonLdCompliance');
        }
    }
    ...
    async testRichSnippets(): Promise<ValidationResults> {
        try {
            ...
            return seoErrorHandler.handle(error as Error, 'testRichSnippets');
        }
    }
