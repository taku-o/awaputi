...
class BrowserCompatibilityManager { /**
    ...
    fallbacksRequired: []);
            ...
            if (supportConfig) {
                ...
                browserInfo.fallbacksRequired = supportConfig.fallbackRequired ? undefined : undefined' }'
...
";"
    ...
    static _createCookieStorageFallback(): StorageFallback { return { ''
            ...
            removeItem: (key: string): void => { try { }
                    ...
                    document.cookie = `awaputi_${key}=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/`;'} catch (e) {'
