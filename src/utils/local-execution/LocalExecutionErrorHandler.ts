...
/**
 * LocalExecutionErrorHandler - ローカル実行特有のエラーハンドリング
 */
export class LocalExecutionErrorHandler {
    /**
     * エラーカテゴリ定数
     */
    ...
    private static _enableFeatureFallback(feature: string, compatibility: CompatibilityInfo): void {
        ...
        try {
            ...
            } else if (feature === 'localStorage' && compatibility.localStorage && compatibility.localStorage.fallbackMethod) {
