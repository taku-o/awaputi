...
export class PerformanceThresholdMonitor {
     ...
     */
    checkMemoryViolations(memory: MemoryInfo): void {
     ...
     */
    checkStabilityViolations(stability: number | undefined): void {
     ...
     */
    checkVarianceViolations(variance: number | undefined): void {
     ...
     */
    recordViolation(violationId: string, severity: string, violationData: any): void {
        const now = Date.now();
     ...
     * @param {string} violationId - Violation ID
     */
    checkViolationEscalation(violationId: string): void {
        const consecutiveCount = this.violations.consecutiveCounts.get(violationId) || 0;
        const violation = this.violations.active.get(violationId);
        if (!violation) return;
     ...
     */
    notifyViolationDetected(violation: ViolationData): void {
        try {
     ...
     * @param {object} violation - Violation object
     */
    notifyViolationResolved(violation: ViolationData): void {
        try {
     ...
     * @param {object} violation - Violation object
     */
    notifyViolationEscalated(violation: ViolationData): void {
        try {
     ...
     */
    getActiveViolations(): ViolationData[] {
     ...
     */
    getViolationHistory(): ViolationHistoryEntry[] {
