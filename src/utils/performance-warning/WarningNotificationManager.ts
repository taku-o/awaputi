...
export class WarningNotificationManager {
     ...
     */
    initializeNotificationSystem(): void {
     ...
     */
    sendNotification(id: string, priority: string, config: NotificationConfig): void {
        // Check cooldown
     ...
     */
    generateNotificationActions(suggestions: string[]): NotificationAction[] {
    ...
    displayNotification(notification: Notification): void {
        if (!this.ui.isInitialized || !this.ui.container) return;
     ...
     */
    executeNotificationAction(notificationId: string, action: NotificationAction): void {
        try {
     ...
     */
    dismissNotification(notificationId: string, reason: string = 'manual'): void {
     ...
     * @param {object} notification - Notification object
     */
    updateNotificationStats(notification: Notification): void {
     ...
     */
    configure(config: Partial<WarningConfig>): void {
