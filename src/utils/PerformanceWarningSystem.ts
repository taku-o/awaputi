...
export class PerformanceWarningSystem {
     ...
     */
    public onViolationDetected(violation: Violation): void {
        try {
     ...
     */
    public onViolationResolved(violation: Violation): void {
        try {
     ...
     */
    public onViolationEscalated(violation: Violation): void {
        try {
     ...
     */
    public createWarning(id: string, priority: string, config: WarningConfig): void {
     ...
     */
    public dismissWarning(warningId: string, reason: string = 'manual'): void {
        // Delegate to notification manager
     ...
     */
    public getSuggestion(suggestionId: string): Suggestion | null {
     ...
     */
    private showBackgroundAppsGuide(): void {
     ...
     */
    private showQualitySettings(): void {
