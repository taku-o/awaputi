...
';'
    ...
    calculateOverallStatistics(results: Map<string, TestCategoryResults>): StatisticsData { const allValues: number[] = [],
        ...
        return { count, mean, median, variance, standard_deviation, min, max,
            percentiles: { p25: this.calculatePercentile(allValues, 25)  },
     ...
     * メトリクス相関計算
     */''
    calculateMetricCorrelations(results: Map<string, TestCategoryResults>): Record<string, number> { return { ', 'frameRate_memory': 0.3,'
