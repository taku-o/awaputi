...
export class PerformanceMetricsCollector {
     ...
     * リグレッション検出
     */
    detectRegressions(testResults: Map<string, TestCategoryResults>): RegressionEntry[] { const regressions: RegressionEntry[] = [],
     ...
     * 外れ値検出
     */
    detectOutliers(testResults: Map<string, TestCategoryResults>): OutlierEntry[] { const outliers: OutlierEntry[] = [],
