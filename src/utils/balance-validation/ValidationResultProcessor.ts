...
interface ProcessedResultMetadata {
    originalValue: any;
    requestedValue: any;
...
export class ValidationResultProcessor {
     ...
     */
    processResults(ruleResults: RuleExecutionResult[], oldValue: any, newValue: any, context: ValidationContext): ProcessedResult {
     ...
     */
    private isAutoFixEligible(ruleResult: RuleExecutionResult, issue: ProcessedIssue): boolean {
     ...
     */
    private shouldApplyAutoFix(processedResult: ProcessedResult): boolean {
     ...
     */
    private processAutoFix(processedResult: ProcessedResult, oldValue: any, newValue: any, context: ValidationContext): any {
     ...
     */
    private generateSummary(processedResult: ProcessedResult, ruleResults: RuleExecutionResult[]): ValidationSummary {
     ...
     * Find slowest rule
     */
    private findSlowestRule(rulesApplied: AppliedRule[]): RulePerformanceInfo | null {
        let slowest: RulePerformanceInfo | null = null;
        let maxTime = 0;
     ...
     * Find fastest rule
     */
    private findFastestRule(rulesApplied: AppliedRule[]): RulePerformanceInfo | null {
        let fastest: RulePerformanceInfo | null = null;
     ...
     */
    private countBySeverity(issues: ProcessedIssue[], severity: string): number {
     ...
     */
    private addToHistory(result: ProcessedResult): void {
