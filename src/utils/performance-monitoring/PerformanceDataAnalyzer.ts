...
export class PerformanceDataAnalyzer {
     ...
     */
    async analyzePerformanceData(timestamp: number, metrics: Map<string, any>): Promise<void> {
        try {
     ...
     */
    detectAnomalies(timestamp: number, metrics: Map<string, any>): void {
     ...
     */
    async generateInsights(timestamp?: number, metrics?: Map<string, any>): Promise<any> {
     ...
     */
    getTrendData(metricId: string): any {
     ...
     * Get recent insights
     */
    getRecentInsights(category?: string | null): any[] {
     ...
     * Configure analyzer
     */
    configure(config: ConfigurationInput): void {
    ...
    // Getters for sub-component access (if needed)
    get anomaliesData(): Anomaly[] {
        return this.anomalies;
    }

    get performanceBaselineData(): Map<string, number> {
        return this.performanceBaseline;
    }

    get isBaselineCalibrated(): boolean {
        return this.baselineCalibrated;
    }

    get trendAnalyzersData(): Map<string, TrendAnalyzer> {
        return this.trendAnalyzers;
    }

    get configData(): AnalysisConfig {
