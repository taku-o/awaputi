...
export class MobileRenderOptimizer {
     ...
     */
    initializeRenderOptimizer(): void {
     ...
     */
    applyInitialOptimizations(): void {
     ...
     */
    detectOptimalQuality(): 'low' | 'medium' | 'high' | 'ultra' {
        ...
        const ___vendor = (gl as any).getParameter((gl as any).VENDOR);
     ...
     */
    setRenderResolution(scale: number): void {
     ...
     */
    getOptimizationSettings(): OptimizationConfig {
        return {
