...
export class ConflictInfo {
     ...
     * 新しい名前を設定
     */
    setNewNames(names: string | string[]): void {
     ...
     * 依存関係を追加
     */
    addDependency(conflictInfo: ConflictInfo): void {
...
export class RenameOperation {
     ...
     * 依存関係を追加
     */
    addDependency(operation: RenameOperation): void {
