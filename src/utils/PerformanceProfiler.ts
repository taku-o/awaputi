...
import { PerformanceAnalyzer, 
    PerformanceReporter,
    PerformanceDashboard } from './performance-profiler/PerformanceAnalysisSystem.js';
...
interface ProfilingSessionOptions {
    duration?: number;
...
interface SessionSummary extends ProfilingSession {
    endTime: number;
    endTimestamp: number;
    duration: number;
    reason: string;
...
export class PerformanceProfiler {
    ...
    async setupAnalysisSystem(): Promise<void> {
        try {
    ...
    exportReport(templateName: string = 'summary', format: string = 'text', filename: string | null = null): any {
...
export function getPerformanceProfiler(): PerformanceProfiler | any {
