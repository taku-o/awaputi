...
export class BrowserCompatibility {
    ...
    private setupTouchDelayFix()';
        ...
        if (existingMeta && existingMeta.parentNode) { existingMeta.parentNode.replaceChild(meta, existingMeta); }
    ...
    calculateOptimalCanvasSize(): CanvasSize { const viewport = {
        ...
        if (canvasSize.width / canvasSize.height > aspectRatio) { canvasSize.width = canvasSize.height * aspectRatio; }
        } else { canvasSize.height = canvasSize.width / aspectRatio; }
        }
