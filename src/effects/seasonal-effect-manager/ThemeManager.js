...
export class ThemeManager {
     ...
     */
    getAvailableSeasons() {
        return Object.keys(this.seasonalThemes);
    }
    
    /**
     * 利用可能なイベント一覧を取得
     * @returns {Array} イベント名配列
     */
    getAvailableEvents() {
     ...
     * @returns {number} パーティクルタイプ数
     * @private
     */
    _countUniqueParticleTypes() {
