...
export class ThemeManager {
    ...
    getSeasonalTheme(season: Season): SeasonalTheme {
        return this.seasonalThemes[season] || this.seasonalThemes.spring;
    }
     ...
     * @returns イベントテーマ
     */
    getEventTheme(eventName: string): EventTheme | undefined {
        return this.eventThemes[eventName];
    }
    ...
    getAvailableSeasons(): Season[] {
        return Object.keys(this.seasonalThemes) as Season[];
    }
    ...
    getAvailableEvents(): string[] {
        return Object.keys(this.eventThemes);
    }
