...
export class ReflectionRenderer {
     ...
     * 反射をレンダリング
     */
    renderReflections(context: CanvasRenderingContext2D, reflectionSurfaces: ReflectionObject[], renderSettings: RenderSettings): void {
        try {
     ...
     * バブル反射をレンダリング
     */
    renderBubbleReflection(context: CanvasRenderingContext2D, surface: ReflectionObject, renderSettings: RenderSettings): void {
        try {
     ...
     * バブルの光沢効果
     */
    renderBubbleGloss(context: CanvasRenderingContext2D, bubble: BubbleObject, reflectivity: number): void {
        try {
     ...
     * バブルの環境反射
     */
    renderBubbleEnvironmentReflection(context: CanvasRenderingContext2D, bubble: BubbleObject, reflectivity: number, lightSources: LightSource[]): void {
        try {
            const radius = bubble.size || 20;
     ...
     * 汎用反射をレンダリング
     */
    renderGenericReflection(context: CanvasRenderingContext2D, surface: ReflectionObject): void {
        try {
            context.save();
            context.globalCompositeOperation = 'multiply';
     ...
     */
    renderBubbleCompleteReflectionSystem(context: CanvasRenderingContext2D, bubble: BubbleObject, renderSettings: RenderSettings): void {
        try {
