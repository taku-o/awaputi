...
export class EffectTransitionRenderer {
     ...
     * フェード遷移をレンダリング
     */
    renderFadeTransition(context: CanvasRenderingContext2D, effect: TransitionEffect, progress: number): void {
        try {
     ...
     * スライド遷移をレンダリング
     */
    renderSlideTransition(context: CanvasRenderingContext2D, effect: TransitionEffect, progress: number): void {
        try {
     ...
     * ズーム遷移をレンダリング
     */
    renderZoomTransition(context: CanvasRenderingContext2D, effect: TransitionEffect, progress: number): void {
        try {
     ...
     * ワイプ遷移をレンダリング
     */
    renderWipeTransition(context: CanvasRenderingContext2D, effect: TransitionEffect, progress: number): void {
        try {
            const canvas = this.canvas;
     ...
     * ディゾルブ遷移をレンダリング
     */
    renderDissolveTransition(context: CanvasRenderingContext2D, effect: TransitionEffect, progress: number): void {
        try {
            // ノイズベースのディゾルブ効果（簡易版）
            const canvas = this.canvas;
