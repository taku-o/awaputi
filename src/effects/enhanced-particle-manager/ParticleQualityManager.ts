...
export class ParticleQualityManager {
     ...
     * 現在の品質レベルを取得
     */
    getCurrentQualityLevel(): QualityLevel { return this.currentQualityLevel }
    
    /**
     * 現在の品質設定を取得
     */
    getCurrentQualitySettings(): QualitySettings { return this.qualitySettings[this.currentQualityLevel] }
