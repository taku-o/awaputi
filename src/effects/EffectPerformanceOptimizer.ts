...
interface ExtendedOptimizationStats extends OptimizationStats {
    currentFPS: number;
    memoryUsage: number;
...
export class EffectPerformanceOptimizer {
    ...
    private optimizeFPS(currentFPS: number): void {
    ...
    private lightOptimization(): void {
        // フレームスキッピングの有効化
    ...
    private limitParticleCount(): void {
    ...
    // 統計とレポート
    public getOptimizationStats(): ExtendedOptimizationStats {
        return {
            ...this.stats,
    ...
    // 手動最適化トリガー
    public manualOptimization(): void {
