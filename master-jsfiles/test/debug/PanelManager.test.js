...
describe('PanelManager', () => {
    ...
    beforeEach(() => {
        ...
        panelManager = new PanelManager(mockDebugInterface);
    ...
    describe('Initialization', () => {
        test('should initialize with default values', () => {
            expect(panelManager.panels).toBeInstanceOf(Map);
            expect(panelManager.panelStates).toBeInstanceOf(Map);
            expect(panelManager.panelConfigs).toBeInstanceOf(Map);
        ...
        test('should setup lifecycle hooks', () => {
            ...
            expect(hooks.beforeCreate).toBeInstanceOf(Set);
            expect(hooks.created).toBeInstanceOf(Set);
            expect(hooks.beforeShow).toBeInstanceOf(Set);
            expect(hooks.shown).toBeInstanceOf(Set);
            expect(hooks.beforeHide).toBeInstanceOf(Set);
            expect(hooks.hidden).toBeInstanceOf(Set);
            expect(hooks.beforeDestroy).toBeInstanceOf(Set);
            expect(hooks.destroyed).toBeInstanceOf(Set);
        });
        ...
        test('should load panel states from localStorage', () => {
            ...
            const newPanelManager = new PanelManager(mockDebugInterface);
    ...
    describe('Panel Registration', () => {
        ...
        test('should create instance immediately for non-lazy panels', () => {
            ...
            expect(panelInfo.instance).toBeInstanceOf(MockPanel);
