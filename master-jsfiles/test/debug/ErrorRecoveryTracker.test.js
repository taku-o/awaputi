...
import { ErrorRecoveryTracker } from '../../src/debug/ErrorRecoveryTracker.js';
...
describe('ErrorRecoveryTracker', () => {
    ...
    beforeEach(() => {
        ...
        recoveryTracker = new ErrorRecoveryTracker(mockErrorReporter);
    ...
    describe('設定とデータ管理', () => {
        ...
        test('復旧データが正しく読み込まれる', () => {
            ...
            const newTracker = new ErrorRecoveryTracker(mockErrorReporter);
