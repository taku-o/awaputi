...
import { EnhancedAutocompleteEngine } from '../../src/debug/EnhancedAutocompleteEngine.js';

describe('EnhancedAutocompleteEngine', () => {
    let mockConsole;
    let mockGameEngine;
    let autocompleteEngine;
    ...
    describe('getSuggestions', () => {
        test('should get command suggestions', () => {
            ...
            expect(suggestions.some(s => s.text === 'config.get')).toBe(true);
