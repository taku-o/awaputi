...
import { ErrorScreenshotCapture } from '../../src/debug/ErrorScreenshotCapture.js';
...
describe('ErrorScreenshotCapture', () => {
    ...
    beforeEach(() => {
        ...
        screenshotCapture = new ErrorScreenshotCapture(mockGameEngine);
    ...
    describe('スクリーンショットキャプチャ', () => {
        ...
        test('Canvas以外の場合はnullが返される', async () => {
            ...
            const testError = new Error('Test error');
            const screenshot = await screenshotCapture.captureOnCriticalError(testError);
