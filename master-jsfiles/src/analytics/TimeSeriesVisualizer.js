...
export class TimeSeriesVisualizer {
     ...
     */
    createSingleMetricChart(canvas, timeSeriesData, metric, options = {}) {
        const {
     ...
     * @returns {Object} Chart.jsのチャートインスタンス
     */
    createMultiMetricChart(canvas, timeSeriesData, metrics, options = {}) {
        const {
            title = '複数指標の推移比較',
        ...
        const config = {
            ...
            options: {
                ...
                scales: {
                    ...this.chartConfigs.default.scales,
                    y: {
     ...
     * @returns {Object} Chart.jsのチャートインスタンス
     */
    createTrendAnalysisChart(canvas, trendAnalysis, options = {}) {
        const {
     ...
     * @returns {Object} Chart.jsのチャートインスタンス
     */
    createDashboardChart(canvas, timeSeriesData, options = {}) {
        const {
        ...
        if (enableAnnotations) {
            this.addAnnotations(chart, timeSeriesData);
        }
