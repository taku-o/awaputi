...
export class VisualEffectAccessibilityManager {
    constructor(effectManager, accessibilityManager) {
        ...
        // 色覚異常対応のカラーマップ
        this.colorBlindnessFilters = new Map([
    ...
    extendParticleManager(particleManager) {
        ...
        // アクセシビリティ対応版に置き換え
        particleManager.createParticle = (x, y, options = {}) => {
            // アクセシビリティ設定を適用
        ...
        particleManager.renderParticle = (context, particle) => {
            // アクセシビリティ対応の描画
    ...
    extendEffectManager(effectManager) {
        ...
        // アクセシビリティ対応版に置き換え
        effectManager.addEffect = (effectType, options = {}) => {
            // アクセシビリティ設定を適用
        ...
        effectManager.renderEffect = (context, effect) => {
            // アクセシビリティ対応の描画
    ...
    extendAnimationManager(animationManager) {
        ...
        // アクセシビリティ対応版に置き換え
        animationManager.createAnimation = (element, animationType, duration, options = {}) => {
            // アクセシビリティ設定を適用
    ...
    async applyAccessibilitySettings() {
        ...
        this.state.colorBlindnessMode = this.config.visual.colorBlindness.enabled 
            ? this.config.visual.colorBlindness.type 
            : 'none';
    ...
    generateReport() {
        return {
            ...
            statistics: {
                ...
                alternativeEffectsCreated: Object.keys(this.reducedMotionSettings.disableEffects).length
            }
        };
    }
