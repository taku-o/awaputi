...
export class UserInfoRenderer {
     ...
     * メインレンダリング処理
     */
    render(context, tabManager, profileManager, helpSystem, dialogManager) {
        try {
     ...
     * タブヘッダーをレンダリング
     */
    renderTabs(context, canvas, tabManager) {
     ...
     * メインコンテンツをレンダリング
     */
    renderContent(context, canvas, tabManager) {
     ...
     * 戻るボタンをレンダリング
     */
    renderBackButton(context, canvas) {
     ...
     * ヒット領域の計算
     */
    calculateHitAreas(canvas, tabManager) {
