...
export class AudioPlaybackController {
     ...
     * @param {AudioNode} sfxGainNode - SFXゲインノード
     * @param {AudioNode} masterGainNode - マスターゲインノード
     * @param {Map} soundBuffers - 音響バッファマップ
     */
    setDependencies(audioContext, sfxGainNode, masterGainNode, soundBuffers) {
     ...
     */
    setMaxConcurrentSounds(maxCount) {
 ...
 */
export function reinitializeAudioPlaybackController() {
    if (audioPlaybackControllerInstance) {
