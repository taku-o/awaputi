...
export class SequentialFileRemover {
     ...
     * @returns {Promise<Object>} バックアップ記録
     */
     ...
     * 復旧手順の生成
     * @param {string} filePath - ファイルパス
     * @param {Object} gitInfo - Git情報
     * @returns {Object} 復旧手順
     */
    generateRecoveryInstructions(filePath, gitInfo) {
        const instructions = {
            method: 'git_history',
            commands: [],
            notes: []
