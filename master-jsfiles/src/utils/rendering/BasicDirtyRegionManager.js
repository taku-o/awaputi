...
export class BasicDirtyRegionManager {
     ...
     * @param {Array} objects - Objects to check for changes
    ...
    /**
     * Calculate dirty regions from object changes
     * @param {Array} objects - Objects to check
     */
     ...
     * @returns {boolean} Whether object has changed
     */
    hasObjectChanged(obj) {
        ...
        return (
            tracking.x !== obj.x ||
            tracking.y !== obj.y ||
            tracking.width !== obj.width ||
            tracking.height !== obj.height ||
            tracking.rotation !== obj.rotation ||
            tracking.scale !== obj.scale ||
            tracking.alpha !== obj.alpha ||
            tracking.visible !== obj.visible ||
            tracking.dirty !== obj.dirty
        );
    }
     ...
     * @returns {object|null} Previous bounds or null
     */
     ...
     * @returns {boolean} Whether regions should be merged
     */
    ...
    /**
     * Merge two regions
     * @param {object} target - Target region to merge into
     * @param {object} source - Source region to merge from
     */
     ...
     * @param {Array} regions - Regions to optimize
     */
     ...
     * @param {Array} regions - Final dirty regions
     */
