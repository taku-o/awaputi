...
class BrowserCompatibilityManager {
    ...
    static getBrowserInfo() {
        try {
            ...
            if (supportConfig) {
                ...
                browserInfo.fallbacksRequired = supportConfig.fallbackRequired ? 
    ...
    static getLocalStorageSupport() {
        ...
        try {
            ...
            // ストレージクォータの推定
            if (support.writable) {
                support.estimatedQuota = this._estimateStorageQuota();
            }
    ...
    static async implementCanvasFallback(size, config = {}) {
        ...
        if (canvasSupport.fallbackMethod === 'static-icons' || 
            this.FALLBACK_CONFIG.canvas.enableStaticIconFallback) {
