import { MainMenuRenderer } from '../../../src/scenes/main-menu/MainMenuRenderer.js';
import { CoordinateCalculator } from '../../../src/utils/CoordinateCalculator.js';
...
describe('MainMenuRenderer', () => {
    ...
    describe('handleResize', () => {
        test('座標計算機を更新する', () => {
            renderer.updateCoordinateCalculator = jest.fn();
    ...
    describe('renderMainMenu', () => {
        ...
        beforeEach(() => {
            ...
            renderer.renderControls = jest.fn();
        });
