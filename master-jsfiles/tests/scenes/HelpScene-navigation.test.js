...
describe('HelpScene Context-Aware Navigation', () => {
    ...
    describe('Navigation Context Integration', () => {
        test('should use NavigationContextManager for go back', () => {
            // ナビゲーションコンテキストをモック
            helpScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue('settings');
            helpScene.navigationContext.popContext = jest.fn();
        ...
        test('should fallback to menu when no return destination', () => {
            // 戻り先がない場合のテスト
            helpScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue(null);
            helpScene.navigationContext.popContext = jest.fn();
        ...
        test('should handle scene switch failure with fallback', () => {
            helpScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue('nonexistent');
            helpScene.navigationContext.popContext = jest.fn();
    ...
    describe('Analytics Integration', () => {
        test('should track contextual help analytics', () => {
            ...
            helpScene.helpContentManager.getHelpAnalytics = jest.fn().mockReturnValue(mockAnalytics);
    ...
    describe('Cleanup', () => {
        test('should cleanup NavigationContextManager on destroy', () => {
            helpScene.navigationContext.cleanup = jest.fn();
