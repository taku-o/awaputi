...
describe('SettingsScene Context-Aware Navigation', () => {
    ...
    describe('Navigation Context Integration', () => {
        test('should use NavigationContextManager for go back', () => {
            // ナビゲーションコンテキストをモック
            settingsScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue('help');
            settingsScene.navigationContext.popContext = jest.fn();
        ...
        test('should fallback to menu when no return destination', () => {
            // 戻り先がない場合のテスト
            settingsScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue(null);
            settingsScene.navigationContext.popContext = jest.fn();
        ...
        test('should handle scene switch failure with fallback', () => {
            settingsScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue('nonexistent');
            settingsScene.navigationContext.popContext = jest.fn();
        ...
        test('should not navigate when editing value', () => {
            ...
            settingsScene.cancelTextEditing = jest.fn();
        ...
        test('should not navigate when showing confirm dialog', () => {
            ...
            settingsScene.closeConfirmDialog = jest.fn();
    ...
    describe('Setting Access Modes', () => {
        ...
        test('should activate quick access mode with specific setting', () => {
            settingsScene.navigateToSetting = jest.fn().mockReturnValue(true);
        ...
        test('should handle quick access mode without target setting', () => {
            settingsScene.navigateToSetting = jest.fn();
    ...
    describe('Error Handling', () => {
        ...
        test('should handle context processing errors', () => {
            ...
            settingsScene.processEntryContext = jest.fn().mockImplementation(() => {
        ...
        test('should handle navigation errors gracefully', () => {
            mockGameEngine.sceneManager.switchScene = jest.fn().mockImplementation(() => {
    ...
    describe('Logging', () => {
        ...
        test('should log successful navigation', () => {
            settingsScene.navigationContext.getReturnDestination = jest.fn().mockReturnValue('menu');
            settingsScene.navigationContext.popContext = jest.fn();
    ...
    describe('Cleanup', () => {
        test('should cleanup NavigationContextManager on destroy', () => {
            settingsScene.navigationContext.cleanup = jest.fn();
        ...
        test('should handle destroy errors gracefully', () => {
            settingsScene.navigationContext.cleanup = jest.fn().mockImplementation(() => {
