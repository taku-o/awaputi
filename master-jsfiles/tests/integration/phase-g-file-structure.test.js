    ...
    describe('インポート依存関係検証', () => {
        test('balance-adjusterのインポート文が正しい', async () => {
            ...
            try {
                ...
                // サブコンポーネントのインポートを確認
                expect(content).toContain("import { BalanceDataLoader } from './BalanceDataLoader.js'");
                expect(content).toContain("import { BalanceCalculator } from './BalanceCalculator.js'");
                expect(content).toContain("import { BalanceValidator } from './BalanceValidator.js'");
                expect(content).toContain("import { BalanceExporter } from './BalanceExporter.js'");
        ...
        test('AudioAccessibilitySupportのインポート文が正しい', async () => {
            ...
            try {
                ...
                // サブコンポーネントのインポートを確認
                expect(content).toContain("import { AudioDescriptionManager } from '../../src/audio/accessibility/AudioDescriptionManager.js'");
                expect(content).toContain("import { AudioCueManager } from '../../src/audio/accessibility/AudioCueManager.js'");
                expect(content).toContain("import { AudioFeedbackManager } from '../../src/audio/accessibility/AudioFeedbackManager.js'");
                expect(content).toContain("import { AudioSettingsManager } from '../../src/audio/accessibility/AudioSettingsManager.js'");
