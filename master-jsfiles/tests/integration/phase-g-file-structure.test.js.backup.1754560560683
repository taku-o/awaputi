    ...
    describe('インポート依存関係検証', () => {
        ...
        test('AudioAccessibilitySupportのインポート文が正しい', async () => {
            ...
            try {
                ...
                // サブコンポーネントのインポートを確認
                expect(content).toContain("import { AudioDescriptionManager } from './AudioDescriptionManager.js'");
                expect(content).toContain("import { AudioCueManager } from './AudioCueManager.js'");
                expect(content).toContain("import { AudioFeedbackManager } from './AudioFeedbackManager.js'");
                expect(content).toContain("import { AudioSettingsManager } from './AudioSettingsManager.js'");
