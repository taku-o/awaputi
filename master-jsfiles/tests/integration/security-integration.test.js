...
import { I18nSecurityManager } from '../../src/core/i18n/I18nSecurityManager.js';
import { I18nSecurityTester } from '../../src/core/i18n/I18nSecurityTester.js';
...
describe('Security Integration Tests', () => {
    ...
    describe('Error Handling', () => {
        test('セキュリティエラー時も適切にフォールバック処理される', () => {
            ...
            localizationManager.securityManager.generateSafeTranslation = jest.fn()
                .mockImplementation(() => {
        ...
        test('翻訳データ検証エラー時の処理', () => {
            // securityManagerをモックしてエラーを発生させる
            localizationManager.securityManager.validateTranslationData = jest.fn()
                .mockImplementation(() => {
    ...
    describe('Cleanup', () => {
        test('セキュリティコンポーネントが適切にクリーンアップされる', () => {
            localizationManager.securityManager.cleanup = jest.fn();
            localizationManager.securityTester.cleanup = jest.fn();
