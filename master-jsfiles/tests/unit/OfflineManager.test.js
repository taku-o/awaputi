...
describe('OfflineManager', () => {
    ...
    describe('オフライン操作記録', () => {
        ...
        test('オフラインモード無効時にエラーが発生する', async () => {
            ...
            const operation = { type: 'save', key: 'test', data: {} };
    ...
    describe('オフライン状態管理', () => {
        test('オフライン状態が正しく保存される', async () => {
            ...
            offlineManager.state.offlineOperations = [{ id: 'op1' }];
        ...
        test('オフライン状態が正しく復元される', async () => {
            const savedState = {
                lastOnlineTime: 123456789,
                offlineOperations: [{ id: 'op1', timestamp: Date.now() }],
        ...
        test('古いオフライン操作が削除される', async () => {
            ...
            const newOperation = {
                id: 'new',
                timestamp: Date.now() - 1 * 24 * 60 * 60 * 1000 // 1日前
            };
    ...
    describe('状態取得', () => {
        test('オフライン状態が正しく返される', () => {
            ...
            offlineManager.state.offlineOperations = [{ id: 'op1' }, { id: 'op2' }];
            offlineManager.state.lastOfflineTime = Date.now() - 60000;
