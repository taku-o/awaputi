...
describe('BalanceCalculator', () => {
    ...
    beforeEach(() => {
        ...
        calculator = new BalanceCalculator(mockGameConfig);
    });
    ...
    describe('難易度計算', () => {
        test('should calculate difficulty correctly', () => {
            const difficulty = calculator.calculateDifficulty('normal');
        ...
        test('should apply level adjustment', () => {
            const difficulty = calculator.calculateDifficulty('normal', 5);
        ...
        test('should handle unknown stage', () => {
            const difficulty = calculator.calculateDifficulty('unknown');
    ...
    describe('レベル調整計算', () => {
        test('should calculate level adjustment correctly', () => {
            const adjustment = calculator.calculateLevelAdjustment(1);
        ...
        test('should reduce difficulty for higher levels', () => {
            const adjustment = calculator.calculateLevelAdjustment(10);
        ...
        test('should have minimum limits', () => {
            const adjustment = calculator.calculateLevelAdjustment(100);
    ...
    describe('泡の設定計算', () => {
        ...
        test('should apply lifetime modifiers', () => {
            const lifetime = calculator.calculateBubbleLifetime('normal', {
                timeMultiplier: 1.5,
                timeBonus: 2000
            });
        ...
        test('should apply health modifiers', () => {
            const health = calculator.calculateBubbleHealth('stone', {
        ...
        test('should have minimum health of 1', () => {
            const health = calculator.calculateBubbleHealth('normal', {
    ...
    describe('推奨アイテム順序', () => {
        test('should recommend items for balanced play style', () => {
            const recommendations = calculator.calculateRecommendedItemOrder({
                currentTAP: 1000,
                currentItems: {},
                playStyle: 'balanced'
            });
    ...
    describe('ゲーム進行度計算', () => {
        test('should calculate game progress correctly', () => {
            const progress = calculator.calculateGameProgress({
    ...
    describe('バランス調整提案', () => {
        test('should suggest reducing spawn rate for short play time', () => {
            const suggestions = calculator.suggestBalanceAdjustments({
