...
describe('FontLoadingManager', () => {
    ...
    beforeEach(() => {
        ...
        FontSourceManager.mockImplementation(() => mockSourceManager);
        FontFallbackHandler.mockImplementation(() => mockFallbackHandler);
        FontErrorHandler.mockImplementation(() => mockErrorHandler);
