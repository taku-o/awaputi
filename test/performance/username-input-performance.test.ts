...
describe('Username Input Performance Tests', () => {
    ...
    class PerformanceOptimizedUsernameInputManager {
        ...
        validateCoordinates(x: number, y: number, canvasInfo: any): boolean {
        ...
        transformCoordinatesBatch(coordinates: Array<{x: number, y: number}>, canvasInfo: any) {
    ...
    describe('Canvas Info Caching', () => {
        ...
        it('should refresh cache after expiration', async () => {
            ...
            (performance.now as any) = jest.fn().mockReturnValue(originalNow() + 20);
