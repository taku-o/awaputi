...
test.describe('Visual Effects Regression Tests', () => {
    ...
    test.describe('Menu Visual Consistency', () => {
        test('main menu should match visual baseline', async ({ page }) => {
            // メインメニューのスクリーンショット
        ...
        test('stage select menu should match visual baseline', async ({ page }) => {
            ...
            await expect(page).toHaveScreenshot('stage-select-baseline.png', {
                fullPage: true,
                threshold: 0.2
            });
        });
    ...
    test.describe('Accessibility Visual Consistency', () => {
        test('high contrast mode should match baseline', async ({ page }) => {
            ...
            await expect(page).toHaveScreenshot('high-contrast-menu.png', {
                fullPage: true,
                threshold: 0.3
            });
        });
