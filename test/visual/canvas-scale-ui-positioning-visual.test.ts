...
describe('Canvas Scale UI Positioning Visual Tests', () => {
    ...
    describe('Screenshot Comparison Tests', () => {
        test('should render UI layout consistently at 800x600 resolution', async () => {
            ...
            const snapshot = createRenderingSnapshot(renderSnapshot: any2913;
        ...
        test('should render UI layout consistently at 1920x1080 resolution', async () => {
            ...
            // 高解像度でのUI要素配置確認
            const snapshot = createRenderingSnapshot(renderSnapshot: any3347;
        ...
        test('should render UI layout consistently at 375x812 resolution (mobile)', async () => {
            ...
            // モバイルでのUI要素配置確認
            const snapshot = createRenderingSnapshot(renderSnapshot: any3993;
        ...
        test('should maintain UI element proportions across different scales', async () => {
            ...
            for (const resolution of testResolutions) {
                ...
                const renderSnapshot = renderUISnapshot();
                snapshots[resolution.name] = createRenderingSnapshot(renderSnapshot: any4989;
            ...
            validateProportionalConsistency(snapshots: any5282;
        });
    });
    ...
    describe('Element Positioning Accuracy Tests', () => {
        ...
        test('should position combo display in top-right corner', async () => {
            ...
            expect(comboCall[1]).toBeGreaterThan(rightSideThreshold: any8413;
        });
    });
    ...
    describe('Cross-Device Consistency Tests', () => {
        test('should maintain consistent layout across desktop sizes', async () => {
            ...
            Object.values(layoutSnapshots: any9264.forEach(snapshot => {
        ...
        test('should optimize layout for mobile sizes', async () => {
            ...
            for (const size of mobileSizes) {
                ...
                validateMobileLayout(snapshot: any11020;
            }
        });
    });
    ...
    function createRenderingSnapshot(renderSnapshot: any15408 {
        return {
    ...
    function validateProportionalConsistency(snapshots: any15941 {
        const resolutionNames = Object.keys(snapshots: any16005;
    ...
    function validateTabletLayout(snapshot, isPortrait) {
        ...
        if (isPortrait) {
            ...
            expect(textElements.some(call => call[2] > 50)).toBe(true: any17162; // 上部からの適切な距離
        } else {
            // ランドスケープモードでの横方向の適切な配置
            const textElements = snapshot.fillTextCalls;
            expect(textElements.some(call => call[1] > 50)).toBe(true: any17366; // 左端からの適切な距離
        }
    }

    function validateMobileLayout(snapshot: any17445 {
        // モバイルレイアウトの基本検証
        expect(snapshot.fillTextCalls.length).toBeGreaterThan(0);
