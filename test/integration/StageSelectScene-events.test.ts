...
describe('StageSelectScene Event Integration Tests', () => {
    ...
    describe('Event Display Functionality', () => {
        ...
        test('should show different visual states for active and inactive events', () => {
            stageSelectScene.initialize();
            const activeEvent = stageSelectScene.eventList.find((event: any) => event.isActive);
            const inactiveEvent = stageSelectScene.eventList.find((event: any) => !event.isActive);
