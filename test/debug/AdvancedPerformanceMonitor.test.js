...
jest.mock('../src/config/PerformanceConfig.js', () => ({
...
const mockGameEngine = {
    ...
    bubbleManager: {
        getActiveBubbleCount: jest.fn(() => 15)
    },
    enhancedParticleManager: {
        getActiveParticleCount: jest.fn(() => 120)
    },
...
describe('AdvancedPerformanceMonitor', () => {
    ...
    beforeEach(() => {
        ...
        // Create instance
        monitor = new AdvancedPerformanceMonitor(mockGameEngine);
    });
    ...
    describe('Initialization', () => {
        ...
        test('should setup metrics objects', () => {
            expect(monitor.metrics.frame).toBeDefined();
        ...
        test('should initialize history manager', () => {
            expect(monitor.historyManager.maxSize).toBe(1000);
    ...
    describe('Metrics Collection', () => {
        ...
        test('should collect memory metrics', () => {
            monitor.metricsCollector.collectMemoryMetrics();
        ...
        test('should collect render metrics', () => {
            monitor.metricsCollector.collectRenderMetrics();
        ...
        test('should collect game metrics', () => {
            monitor.metricsCollector.collectGameMetrics();
        ...
        test('should collect system metrics', () => {
            monitor.metricsCollector.collectSystemMetrics();
    ...
    describe('History Management', () => {
        ...
        test('should limit history size', () => {
            monitor.historyManager.maxSize = 3;
    ...
    describe('Performance Analysis', () => {
        ...
        test('should detect memory pressure anomalies', () => {
            monitor.metrics.memory.pressureLevel = 0.85; // High pressure
            monitor.detectAnomalies();
        ...
        test('should detect frame variance anomalies', () => {
            monitor.metrics.frame.fpsVariance = 15; // High variance
            monitor.detectAnomalies();
        ...
        test('should generate FPS predictions', () => {
        ...
        test('should generate performance recommendations', () => {
            monitor.metrics.frame.currentFPS = 40; // Low FPS
        ...
        test('should calculate trend correctly', () => {
            const increasingValues = [10, 15, 20, 25, 30];
    ...
    describe('Public API', () => {
        ...
        test('should get history data by type', () => {
            // Add some test data
            monitor.historyManager.data.fps = [
                { timestamp: Date.now(), value: 60 },
                { timestamp: Date.now() - 1000, value: 58 }
            ];
        ...
        test('should get history data with time range', () => {
            ...
            monitor.historyManager.data.fps = [
                ...
                { timestamp: now - 30000, value: 58 }, // 30 seconds ago
                { timestamp: now - 60000, value: 55 }  // 1 minute ago
            ];
        ...
        test('should get all history data', () => {
        ...
        test('should reset data', () => {
            // Add some test data
            monitor.historyManager.data.fps = [{ timestamp: Date.now(), value: 60 }];
    ...
    describe('Error Handling', () => {
        ...
        test('should handle missing game engine gracefully', () => {
            const monitorWithoutEngine = new AdvancedPerformanceMonitor(null);
        ...
        test('should handle missing performance optimizer gracefully', () => {
            ...
            const monitorWithoutOptimizer = new AdvancedPerformanceMonitor(gameEngineWithoutOptimizer);
    ...
    describe('Integration with PerformanceOptimizer', () => {
        ...
        test('should handle frame completion from optimizer', () => {
            const frameData = {
                fps: 55,
                frameTime: 18.18,
                droppedFrames: 1
