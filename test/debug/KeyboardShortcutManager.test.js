...
describe('KeyboardShortcutManager', () => {
    ...
    beforeEach(() => {
        ...
        // Create instance
        shortcutManager = new KeyboardShortcutManager(mockDebugInterface);
    });
    ...
    describe('Initialization', () => {
        test('should initialize with default values', () => {
            ...
            expect(shortcutManager.shortcutGroups).toBeInstanceOf(Map);
            expect(shortcutManager.contexts).toBeInstanceOf(Map);
    ...
    describe('Public API', () => {
        test('should get all shortcuts', () => {
            ...
            expect(allShortcuts).toBeInstanceOf(Map);
