...
const mockCanvas = {
    ...
    toDataURL: jest.fn(() => 'data:image/png;base64,mock-data'),
    getBoundingClientRect: jest.fn(() => ({ left: 10, top: 10 }))
};
...
describe('PerformanceVisualizer', () => {
    ...
    describe('Rendering', () => {
        test('should render charts when visible', () => {
            ...
            const renderCallback = (global.requestAnimationFrame as jest.Mock).mock.calls[0][0];
            renderCallback();
    ...
    describe('Mouse Interaction', () => {
        test('should handle mouse move events', () => {
            ...
            const mouseMoveCallback = (mockCanvas.addEventListener as jest.Mock).mock.calls.find(
        ...
        test('should handle mouse click events', () => {
            ...
            const mouseClickCallback = (mockCanvas.addEventListener as jest.Mock).mock.calls.find(
                call => call[0] === 'click'
            )[1];
        ...
        test('should handle wheel events for zoom', () => {
            ...
            const wheelCallback = (mockCanvas.addEventListener as jest.Mock).mock.calls.find(
                call => call[0] === 'wheel'
            )[1];
