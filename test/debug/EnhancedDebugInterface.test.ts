...
describe('EnhancedDebugInterface', () => {
    ...
    describe('Panel Management', () => {
        ...
        class MockPanel {
            ...
            constructor(gameEngine: any, debugInterface: any) {
    ...
    describe('Settings Management', () => {
        test('should save settings to localStorage', () => {
            ...
            const saved = JSON.parse(localStorage.getItem('enhanced-debug-settings') as string);
    ...
    describe('Cleanup', () => {
        ...
        test('should save session data on destroy', () => {
            ...
            debugInterface.destroy();
            const sessionData = JSON.parse(localStorage.getItem('enhanced-debug-session') as string);
