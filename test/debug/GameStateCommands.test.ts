...
describe('GameStateCommands', () => {
    ...
    describe('Initialization', () => {
        ...
        test('should register all command categories', () => {
            ...
            const registeredCommands = mockConsole.registerCommand.mock.calls.map((call: any) => call[0]);
        ...
        test('should setup safety checks', () => {
            expect(gameStateCommands.safetyChecks.confirmDestructive).toBe(true);
    ...
    describe('Game Control Commands', () => {
        let pauseCommand: any, resumeCommand: any, resetCommand: any, statusCommand: any;
        
        beforeEach(() => {
            // Extract registered commands
            const commands: Record<string, any> = {};
            mockConsole.registerCommand.mock.calls.forEach(([name, config]: any) => {
    ...
    describe('Score Commands', () => {
        let setScoreCommand: any, addScoreCommand: any, resetComboCommand: any, highScoreCommand: any;
    ...
    describe('Bubble Commands', () => {
        let spawnBubbleCommand: any, clearBubblesCommand: any, bubbleInfoCommand: any;
    ...
    describe('Player Data Commands', () => {
        let setAPCommand: any, setLevelCommand: any, playerInfoCommand: any, resetPlayerCommand: any;
    ...
    describe('Level Commands', () => {
        let gotoStageCommand: any, listStagesCommand: any, setDifficultyCommand: any;
    ...
    describe('Debug Commands', () => {
        let runTestCommand: any, dumpStateCommand: any, undoCommand: any;
