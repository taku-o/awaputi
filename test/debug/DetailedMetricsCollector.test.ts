...
describe('DetailedMetricsCollector', () => {
    ...
    describe('Initialization', () => {
        ...
        test('should initialize profiling data structures', () => {
            expect(collector.profilingData.renderPipeline).toBeInstanceOf(Map);
            expect(collector.profilingData.memoryAllocations).toEqual([]);
            expect(collector.profilingData.gameLoopBreakdown).toBeInstanceOf(Map);
            expect(collector.profilingData.webGLCalls).toEqual([]);
            expect(collector.profilingData.audioProcessing).toBeInstanceOf(Map);
        });
