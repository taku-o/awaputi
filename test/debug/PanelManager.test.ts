...
class MockPanel {
    ...
    constructor(gameEngine: any, debugInterface: any, options: any = {}) {
...
describe('PanelManager', () => {
    ...
    describe('Panel Information', () => {
        ...
        test('should get all panels', () => {
            ...
            expect(allPanels.map((p: any) => p.name)).toContain('panel1');
            expect(allPanels.map((p: any) => p.name)).toContain('panel2');
        });
