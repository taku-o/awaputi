...
describe('PerformanceThresholdMonitor', () => {
    ...
    beforeEach(() => {
        ...
        jest.clearAllMocks();
        jest.useFakeTimers();
        (global as any).Notification.reset();
    ...
    describe('Notification System', () => {
        ...
        test('should create browser notification when permission granted', () => {
            ...
            monitor.checkThresholds();
            expect((global as any).Notification.instances.length).toBe(1);
            expect((global as any).Notification.instances[0].title).toBe('Performance CRITICAL');
        });
        ...
        test('should not create browser notification when permission denied', () => {
            ...
            monitor.checkThresholds();
            expect((global as any).Notification.instances.length).toBe(0);
        });
    ...
    describe('Auto Recovery', () => {
        ...
        test('should attempt memory recovery for critical memory alert', () => {
            ...
            (global as any).window.gc = jest.fn();
    ...
    describe('Alert Management', () => {
        ...
        test('should cleanup old notifications', () => {
            ...
            expect(monitor.warningSystem.notifications.length).toBe(2);
            expect(monitor.warningSystem.notifications.find((n: any) => n.id === 'old1')).toBeUndefined();
            expect(monitor.warningSystem.notifications.find((n: any) => n.id === 'old2')).toBeDefined();
            expect(monitor.warningSystem.notifications.find((n: any) => n.id === 'recent')).toBeDefined();
        });
    });
    ...
    describe('Public API', () => {
        ...
        test('should get current suggestions sorted by priority', () => {
            ...
            for (let i = 0; i < suggestions.length - 1; i++) {
                ...
                const currentPriority = priorityMap[suggestions[i].priority];
                const nextPriority = priorityMap[suggestions[i + 1].priority];
