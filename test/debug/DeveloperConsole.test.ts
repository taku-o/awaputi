...
interface MockFunction<T = any> extends Function {
 mockReturnValue: (value: T) => MockFunction<T>,
    ...
    toHaveBeenCalledWith: (void) => void;
    toHaveBeenCalled: ($2) => void;;'
    mockRestore: ($2) => void;;'
    mockClear: () => void 
}
}
...
interface ConfigurationManager { get: MockFunction<$2>;
    set: MockFunction<boolean>;
    getDefault: MockFunction<$2>;
    getAll: MockFunction<any>;
    getAllDefaults: MockFunction<$2>;
...
interface ConsoleLike { print: MockFunction<$2>;
...
describe('DeveloperConsole', () => {  let devConsole: DeveloperConsole,
    let consoleLogSpy: MockFunction<$2>;
    let consoleWarnSpy: MockFunction<$2>;,'
    let consoleErrorSpy: MockFunction<$2>;,'
    beforeEach((') => { }
        // Console spies' }
