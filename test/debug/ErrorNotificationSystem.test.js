...
import { ErrorNotificationSystem } from '../../src/debug/ErrorNotificationSystem.js';
...
describe('ErrorNotificationSystem', () => {
    ...
    beforeEach(() => {
        ...
        notificationSystem = new ErrorNotificationSystem(mockErrorReporter);
    ...
    describe('初期化', () => {
        test('ErrorNotificationSystemが正しく初期化される', () => {
            ...
            expect(notificationSystem.pendingNotifications).toBeInstanceOf(Map);
        });
    ...
    describe('設定管理', () => {
        ...
        test('設定が正しく読み込まれる', () => {
            ...
            // 新しいインスタンスを作成
            const newNotificationSystem = new ErrorNotificationSystem(mockErrorReporter);
