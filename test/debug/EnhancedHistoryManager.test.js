...
import { EnhancedHistoryManager } from '../../src/debug/EnhancedHistoryManager.js';
...
describe('EnhancedHistoryManager', () => {
    ...
    beforeEach(() => {
        ...
        historyManager = new EnhancedHistoryManager(mockConsole);
    });
    ...
    describe('navigate', () => {
        ...
        test('should handle empty history', () => {
            const emptyManager = new EnhancedHistoryManager(mockConsole);
    ...
    describe('Storage persistence', () => {
        ...
        test('should load history from localStorage', () => {
            ...
            const newHistoryManager = new EnhancedHistoryManager(mockConsole);
