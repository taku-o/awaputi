...
- [ ] 5. スクリーンショット機能の基盤実装
  ...
  - 画像フォーマット変換（PNG/JPEG）機能を実装
  - 画像品質とサイズ最適化機能を実装
  - _要件: 2.1, 2.3, 8.1_

- [ ] 6. スクリーンショットオーバーレイ機能の実装
  - スコア情報オーバーレイ生成機能を実装
...
- [ ] 7. 共有UI基盤の実装
  ...
  - 共有ダイアログのベースクラスを実装
  - モーダル表示とクローズ機能を実装
  - アクセシビリティ対応（キーボードナビゲーション、ARIA）を実装
  - _要件: 7.1, 7.5_
